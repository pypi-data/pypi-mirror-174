...
from chalk.features.feature import unwrap_feature, unwrap_features
...
def test_class_etl_offline_to_online():
    ...
    assert unwrap_features(ETLFeatures).__chalk_etl_offline_to_online__ is True
    assert unwrap_features(MaxStalenessFeatures).__chalk_etl_offline_to_online__ is None
...
def test_class_max_staleness():
    ...
    assert unwrap_features(MaxStalenessFeatures).__chalk_max_staleness__ == "4d"
    assert unwrap_features(ETLFeatures).__chalk_max_staleness__ is None
