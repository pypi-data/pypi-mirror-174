...
class PluginKeywords:
    @staticmethod
    def fullname_is_dataframe_class(fullname):
        return re.match(r"chalk\.feature_n\.feature_[0-9]+\.feature.DataFrame", fullname) is not None

    feature_set_decorators = {
        # "features"
        "chalk.features.feature_set.features"
        # dataclasses.dataclass
    }

    dataframe_meta = "chalk.features.dataframe.DataFrameMeta"

    feature_makers = {"chalk.features.feature_set.feature"}

    features_class = "chalk.features.feature.Features"

    dataframe_class = "chalk.features.dataframe.DataFrame"
