...
class TeamsLocation(
    ...
    def __init__(
        ...
        *,
        ...
        networks: typing.Optional[typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["TeamsLocationNetworks", typing.Dict[str, typing.Any]]]]] = None,
    ...
    def put_networks(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["TeamsLocationNetworks", typing.Dict[str, typing.Any]]]],
    ) -> None:
        '''
        :param value: -
        '''
...
class TeamsLocationNetworks:
    def __init__(self, *, network: builtins.str) -> None:
        ...
        '''
        if __debug__:
            def stub(*, network: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class TeamsLocationNetworksOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[TeamsLocationNetworks, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[TeamsLocationNetworks, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[TeamsLocationNetworks, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[TeamsLocationNetworks, cdktf.IResolvable]],
