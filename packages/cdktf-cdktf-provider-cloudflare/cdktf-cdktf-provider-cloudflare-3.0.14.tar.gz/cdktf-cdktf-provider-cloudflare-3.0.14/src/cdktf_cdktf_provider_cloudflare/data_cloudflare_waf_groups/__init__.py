...
class DataCloudflareWafGroups(
    ...
    def __init__(
        ...
        *,
        ...
        filter: typing.Optional[typing.Union["DataCloudflareWafGroupsFilter", typing.Dict[str, typing.Any]]] = None,
...
class DataCloudflareWafGroupsFilterOutputReference(
    ...
    def internal_value(
        ...
        if __debug__:
            def stub(value: typing.Optional[DataCloudflareWafGroupsFilter]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataCloudflareWafGroupsGroupsOutputReference(
    ...
    def internal_value(
        ...
        if __debug__:
            def stub(value: typing.Optional[DataCloudflareWafGroupsGroups]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
