...
def run_tests(c: ServiceSettings, **kwargs) -> Any:
    ...
    Args:
        c (ServiceSettings): _description_
...
def garbage_collection(
    ...
    if models_to_keep >= latest_model_version or c.keep_all_models is True:
        logging.info(
            f"Skipping garbage collection, will keep all versions of model {c.human_friendly_model_name} in {env} alive"
        )
    else:
        logging.info(
