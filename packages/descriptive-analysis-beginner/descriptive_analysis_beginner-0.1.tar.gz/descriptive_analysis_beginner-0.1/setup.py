...
setup(
  name = 'descriptive_analysis_beginner',
  packages = ['descriptive_analysis_beginner'],   
  version = '0.1',      
  license='MIT',        
  ...
  url = 'https://github.com/nagorebermeosolo/descriptive_analysis_beginner',   
  download_url = 'https://github.com/nagorebermeosolo/descriptive_analysis_beginner/archive/refs/tags/0.1.tar.gz',   
