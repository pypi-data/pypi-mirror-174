...
class UserRolesApi(object):
    ...
    def add_policy_collection_to_user_role_with_http_info(self, userid, add_policy_collection_to_role_request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'userid' in local_var_params and not re.search(r'^[a-zA-Z0-9]+$', local_var_params['userid']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `userid` when calling `add_policy_collection_to_user_role`, must conform to the pattern `/^[a-zA-Z0-9]+$/`")  # noqa: E501
        collection_formats = {}
        ...
        header_params['X-LUSID-SDK-Version'] = '0.0.2458'
    ...
    def add_policy_to_user_role_with_http_info(self, userid, add_policy_to_role_request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'userid' in local_var_params and not re.search(r'^[a-zA-Z0-9]+$', local_var_params['userid']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `userid` when calling `add_policy_to_user_role`, must conform to the pattern `/^[a-zA-Z0-9]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def delete_user_role_with_http_info(self, userid, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'userid' in local_var_params and not re.search(r'^[a-zA-Z0-9]+$', local_var_params['userid']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `userid` when calling `delete_user_role`, must conform to the pattern `/^[a-zA-Z0-9]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_user_role_with_http_info(self, userid, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'userid' in local_var_params and not re.search(r'^[a-zA-Z0-9]+$', local_var_params['userid']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `userid` when calling `get_user_role`, must conform to the pattern `/^[a-zA-Z0-9]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def remove_policy_collection_from_user_role_with_http_info(self, userid, policy_collection_scope, policy_collection_code, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'userid' in local_var_params and not re.search(r'^[a-zA-Z0-9]+$', local_var_params['userid']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `userid` when calling `remove_policy_collection_from_user_role`, must conform to the pattern `/^[a-zA-Z0-9]+$/`")  # noqa: E501
    ...
    def remove_policy_from_user_role_with_http_info(self, userid, policy_scope, policy_code, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'userid' in local_var_params and not re.search(r'^[a-zA-Z0-9]+$', local_var_params['userid']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `userid` when calling `remove_policy_from_user_role`, must conform to the pattern `/^[a-zA-Z0-9]+$/`")  # noqa: E501
    ...
    def update_user_role_with_http_info(self, userid, user_role_update_request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'userid' in local_var_params and not re.search(r'^[a-zA-Z0-9]+$', local_var_params['userid']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `userid` when calling `update_user_role`, must conform to the pattern `/^[a-zA-Z0-9]+$/`")  # noqa: E501
        collection_formats = {}
