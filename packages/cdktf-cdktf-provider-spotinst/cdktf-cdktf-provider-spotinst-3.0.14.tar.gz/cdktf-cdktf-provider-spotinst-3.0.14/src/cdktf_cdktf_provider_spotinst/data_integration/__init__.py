...
class DataIntegration(
    ...
    def __init__(
        ...
        *,
        ...
        s3: typing.Optional[typing.Union["DataIntegrationS3", typing.Dict[str, typing.Any]]] = None,
        ...
        :param id: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/spotinst/r/data_integration#id DataIntegration#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
...
class DataIntegrationS3OutputReference(
    ...
    def internal_value(self, value: typing.Optional[DataIntegrationS3]) -> None:
        if __debug__:
            def stub(value: typing.Optional[DataIntegrationS3]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
