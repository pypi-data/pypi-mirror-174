...
class MultaiTarget(
    ...
    def __init__(
        ...
        *,
        ...
        tags: typing.Optional[typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["MultaiTargetTags", typing.Dict[str, typing.Any]]]]] = None,
        ...
        :param id: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/spotinst/r/multai_target#id MultaiTarget#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
    ...
    def put_tags(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["MultaiTargetTags", typing.Dict[str, typing.Any]]]],
    ) -> None:
        '''
        :param value: -
        '''
...
class MultaiTargetTagsList(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List[MultaiTargetTags]]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[MultaiTargetTags]]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[MultaiTargetTags]]],
...
class MultaiTargetTagsOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[MultaiTargetTags, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[MultaiTargetTags, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[MultaiTargetTags, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[MultaiTargetTags, cdktf.IResolvable]],
