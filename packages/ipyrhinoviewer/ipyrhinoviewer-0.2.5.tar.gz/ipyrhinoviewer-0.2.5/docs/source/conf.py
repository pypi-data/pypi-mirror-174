...
# -*- coding: utf-8 -*-
#
# ipyrhinoviewer documentation build configuration file
#
...
project = 'ipyrhinoviewer'
copyright = '2022, Florian Jaeger'
...
_version_py = os.path.join(repo, 'ipyrhinoviewer', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipyrhinoviewerdoc'
...
latex_documents = [
    (master_doc, 'ipyrhinoviewer.tex', 'ipyrhinoviewer Documentation',
     'Florian Jaeger', 'manual'),
]
