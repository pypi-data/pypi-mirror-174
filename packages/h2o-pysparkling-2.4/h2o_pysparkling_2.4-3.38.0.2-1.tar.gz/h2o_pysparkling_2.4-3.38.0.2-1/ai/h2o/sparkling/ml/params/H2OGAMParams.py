...
class H2OGAMParams(HasIgnoredCols, HasBetaConstraints, HasGamCols, Params):
    ...
    splineOrders = Param(
        Params._dummy(),
        "splineOrders",
        """Only valid for bs=2 monotone I splines.  Order of I-splines used for gam predictors. If specified, must be the same size as gam_columns.  Values for bs=0 or 1 will be ignored.""",
        H2OTypeConverters.toNullableListInt())
