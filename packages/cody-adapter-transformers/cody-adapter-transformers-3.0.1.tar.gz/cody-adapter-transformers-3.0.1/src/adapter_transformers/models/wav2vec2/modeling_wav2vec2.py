...
class Wav2Vec2ForPreTraining(Wav2Vec2PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from adapter_transformers import Wav2Vec2FeatureExtractor, Wav2Vec2ForPreTraining
...
class Wav2Vec2ForMaskedLM(Wav2Vec2PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import Wav2Vec2Processor, Wav2Vec2ForMaskedLM
        >>> from datasets import load_dataset
        >>> import soundfile as sf
        >>> import torch
