...
class LayoutLMv2Model(LayoutLMv2PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import LayoutLMv2Processor, LayoutLMv2Model
...
class LayoutLMv2ForSequenceClassification(LayoutLMv2PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import LayoutLMv2Processor, LayoutLMv2ForSequenceClassification
        >>> from PIL import Image
        >>> import torch
...
class LayoutLMv2ForTokenClassification(LayoutLMv2PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import LayoutLMv2Processor, LayoutLMv2ForTokenClassification
        >>> from PIL import Image
...
class LayoutLMv2ForQuestionAnswering(LayoutLMv2PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import LayoutLMv2Processor, LayoutLMv2ForQuestionAnswering
        >>> from PIL import Image
        >>> import torch
