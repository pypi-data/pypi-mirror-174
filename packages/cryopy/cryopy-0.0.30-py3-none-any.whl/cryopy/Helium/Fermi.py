...
def temperature(fraction_3he):
    ...
    3 * np.pi ** 2 * Constant.avogadro() * fraction_3he / Helium7.temperature, pressure, fraction_3he) ** (2 / 3)
...
def chemical_potential(temperature, fraction_3he):
    ...
    return Constant.gas() * Fermi.temperature(fraction_3he) + 5 / 3 * Fermi.temperature(fraction_3he) * integrate.quad(
        Fermi.molar_specific_heat, 0, t, fraction_3he) - temperature * molar_entropy(temperature, fraction_3he)
