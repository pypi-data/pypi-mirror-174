...
from PyQt5.QtCore import QObject, pyqtSlot, QThread, QJsonValue
...
class qmlScopeCache(QObject):
    ...
    def data(self, aName: str) -> QJsonValue:
        return self.m_scope.data(aName)
...
class qmlStream(QObject):
    ...
    def data(self) -> QJsonValue:
        ret = self.__m_stream.data()
        return ret
