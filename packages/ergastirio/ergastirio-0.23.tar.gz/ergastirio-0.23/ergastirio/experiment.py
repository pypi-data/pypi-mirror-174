...
class experiment(QtCore.QObject):
    ...
    sig_data_updated_added_new_rows = QtCore.pyqtSignal(int) 
    sig_data_updated_deleted_all_data = QtCore.pyqtSignal(int) 
    sig_data_updated_deleted_last_rows = QtCore.pyqtSignal(int) 
