...
class TTTH_Analyzer:
    ...
    def check_outlier_of_numerical_variable(self, numerical_variable, df):
        ...
        if index_up.empty and index_low.empty:
            ...
            print(f'variable {numerical_variable} have {round(upper_outlier_ratio, 3)}% upper outlier')
            print(f'variable {numerical_variable} have {round(lower_outlier_ratio, 3)}% lower outlier')
