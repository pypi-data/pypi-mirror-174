...
from mmcv.runner import HOOKS, LogBuffer, build_optimizer, build_runner, get_dist_info
from mmcv.utils import build_from_cfg

from blette import digit_version
from blette.datasets import build_dataloader, build_dataset
from blette.utils import find_latest_checkpoint, get_root_logger
from blette.core import EvalHook, DistEvalHook


class PatchLogBuffer(LogBuffer):
    """Patched LogBuffer

    https://github.com/open-mmlab/mmcv/pull/1972
    """
...
def train_det(
    ...
    # use a patched logbuffer for LoggerHook
    runner.log_buffer = PatchLogBuffer()
