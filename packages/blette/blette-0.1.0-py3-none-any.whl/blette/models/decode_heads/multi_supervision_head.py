        ...
        *,
        ...
        if loss_multilabel is None:
            ...
            if isinstance(loss_multilabel, dict):
                ...
                self.loss_multilabel = build_loss(loss_multilabel)
                ...
                for loss in loss_multilabel:
                    ...
                    self.loss_multilabel.append(build_loss(loss))
            else:
                raise TypeError(
