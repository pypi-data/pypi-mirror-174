...
# FIXME: instance sensitive edges for binary is not supported
# need to change internals of `pyEdgeEval`
...
class CustomBinaryLabelDataset(BaseBinaryDataset):
    def __init__(
        self,
        edge_dir=None,
        ...
        **kwargs,
        ...
        super(CustomBinaryLabelDataset, self).__init__(**kwargs)
...
@DATASETS.register_module()
class OTFCustomBinaryLabelDataset(BaseBinaryDataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(OTFCustomBinaryLabelDataset, self).__init__(**kwargs)
