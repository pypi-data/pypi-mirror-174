...
x q[1]; //cycle: 38 //x q[3]
cx q[0],q[2]; //cycle: 39 //cx q[1],q[2]
//36 original gates
//38 gates in generated circuit
//36 ideal depth (cycles)
//41 depth of generated circuit
//883 nodes popped from queue for processing.
//1207 nodes remain in queue.
//HashFilter filtered 1827 total nodes.
//HashFilter2 filtered 683 total nodes.
//HashFilter2 marked 860 total nodes.
