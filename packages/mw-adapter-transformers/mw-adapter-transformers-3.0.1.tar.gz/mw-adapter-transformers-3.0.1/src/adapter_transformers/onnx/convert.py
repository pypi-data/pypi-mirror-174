...
from adapter_transformers import PreTrainedModel, PreTrainedTokenizer, TensorType, TFPreTrainedModel, is_torch_available
from adapter_transformers.file_utils import is_tf_available, is_torch_onnx_dict_inputs_support_available
from adapter_transformers.onnx.config import OnnxConfig
...
def export(
    ...
    if is_torch_available():
        from adapter_transformers.file_utils import torch_version
