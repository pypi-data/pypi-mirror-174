...
# generate-gender-options is about to set female, male, or undefined
# in the dataset you must express the range of percentages
# about each gender option, for example, from 100% until 55% of
# females, the gender is female and, from 55% until 45% of females or
# males, the gender is unknown or undefined
parser.add_argument('--generate-gender-options',
                    default="100-55,100-55,55-45",
                    action="store_true")
