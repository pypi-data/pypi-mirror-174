...
class Plotter(object):
    ...
    def draw_dashboard_plots(self, plot_order=None, **kwargs):
        ...
        def parse_date(dt, direction):
            if isinstance(dt, (int, float, long)):
                ...
                try:
                    ...
                    if direction == 'backward':
                        dt = datetime.today() - timedelta(days=45)
                    else:
        ...
        if max_date:
            max_date = parse_date(max_date, 'forward')
        else:
            max_date = datetime.today() + timedelta(days=4)
    ...
    def __plot(self, plot_name, plot_params, **kwargs):
        ...
        if plot_name.replace(' ', '_').lower() == 'xplot_pwr_poa':
            ...
            fig, axs = plt.subplots(5, sharex=True, num='Native Weather')
            fig.suptitle(self.project.project_name)
