...
class DashboardSession(object):
    ...
    def pickle_project(self, project_name, year=None):
    ...
    def pickle_projects(self, project_list, year=None):
        ...
        if isinstance(project_list, (str, Project)):
            project_name = project_list
            self.pickle_project(project_name)
            return
        elif isinstance(project_list, list):
            for project_name in project_list:
                self.pickle_project(project_name)
    ...
    def load_pickle(self, project_name, year=None, data_cutoff_date=None):
        ...
        """
        # TODO: add in functionality to extend data cutoff date to current date that the pickle is loaded at
        if not year:
    ...
    def load_pickles(self, project_list, year=None):
