...
class EnrollRecordSubitemAdmin(admin.ModelAdmin):
    list_display = ('id', 'enroll_record', 'enroll_subitem', 'user_id', 'price', 'count', 'subitem_amount', 'enroll_subitem_status_code')
    search_fields = ('id', 'enroll_record', 'enroll_subitem', 'user_id', 'price', 'count', 'subitem_amount',)
    fields = ('id', 'enroll_record_id', 'enroll_subitem', 'user_id', 'price', 'count', 'subitem_amount', 'enroll_subitem_status_code')
    readonly_fields = ['id', ]
