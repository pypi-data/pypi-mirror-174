...
class EnrollRecordSubitemAdmin(admin.ModelAdmin):
    list_display = ('id', 'enroll_record', 'enroll_subitem', 'user_id', 'price', 'count', 'subitem_amount',)
    search_fields = ('id', 'enroll_record', 'enroll_subitem', 'user_id', 'price', 'count', 'subitem_amount',)
    fields = ('id', 'enroll_record_id', 'enroll_subitem', 'user_id', 'price', 'count', 'subitem_amount',)
    readonly_fields = ['id', ]
