...
class EnrollServices:
    ...
    def enroll_detail(enroll_id, simple_return=False):
        ...
        if not simple_return:
            ...
            # 清单总数
            enroll_detail["detailed_count"] = 0
            if not err and isinstance(enroll_detail["subitem"], list) and len(enroll_detail["subitem"]) >= 1:
