...
from typing import Iterator, Match, NamedTuple, Pattern, Type, Union
...
class Docket:
    ...
    def __str__(self) -> str:
        if self.first_id or self.cleaned_ids:
            return f"{self.short_category} {self.first_id or self.cleaned_ids}, {self.formatted_date}"
