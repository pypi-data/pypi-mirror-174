...
def urlopen(key, secret, url, data=None, headers=None, method=None, timeout=9000, content_type=None):
    if headers is None:
        headers = {}
    ...
    req.add_header('Content-Type', 'application/json;charset=utf-8' if content_type is None else content_type)
