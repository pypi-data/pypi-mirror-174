...
def enable_service_now():
    if not os.path.isfile("/usr/lib/systemd/user/dmt.service"):
        os.system("sudo git archive --remote=git@gitlab.com:waser-technologies/technologies/dmt.git HEAD | sudo tar xvf - dmt.service.example && sudo mv dmt.service.example /usr/lib/systemd/user/dmt.service")
