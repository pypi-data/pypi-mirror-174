...
class StacIngestor(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        api_env: typing.Mapping[builtins.str, builtins.str],
...
class StacIngestorProps:
    ...
    @builtins.property
    def api_env(self) -> typing.Mapping[builtins.str, builtins.str]:
        '''(experimental) Environment variables to be sent to Lambda.

        :stability: experimental
        '''
        result = self._values.get("api_env")
        assert result is not None, "Required property 'api_env' is missing"
