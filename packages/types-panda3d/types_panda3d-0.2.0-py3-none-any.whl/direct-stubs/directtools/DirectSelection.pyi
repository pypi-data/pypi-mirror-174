...
class SelectionSegment(SelectionQueue):
    ...
    def pickGeom(
        self, targetNodePath: NodePath | None = ..., endPointList: Sequence = ..., skipFlags: int = ...
    ) -> CollisionEntry: ...
    def pickBitMask(
        self, bitMask: BitMask32 = ..., targetNodePath: NodePath | None = ..., endPointList: Sequence = ..., skipFlags: int = ...
    ) -> CollisionEntry: ...
