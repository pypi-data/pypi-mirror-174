...
class DataBlob:
    ...
    Here's an example of using the Datablob class to pull data from an AWS S3 bucket:
    ...
    def ls(
        ...
        Here's an example of displaying the details of datablobs created by the currently logged-in user:
        ...
        Example:
            ...
            # Optional Step: For demonstration purpose, create a new datablob from S3
            db = DataBlob.from_s3(
                uri="{fill in uri}",
                cloud_provider="aws",
                region="eu-west-3"
            ...
            # Get the list of all DataBlob instances created by the currently logged-in user
            dx = DataBlob.ls()
            print(dx)

            # Display the details of the instances in a pandas dataframe
            df = DataBlob.as_df(dx)
            print(df)
            ```
        """
...
def details(self: DataBlob) -> pd.DataFrame:
    ...
    Here's an example to get details of a datablob from the server:
    ...
    Example:
        ...
        # To display the details of all datablob created by the user, use
        # the method below.
...
def to_datasource(
    ...
    **kwargs,
    ...
    Here's an example of how to create a DataSource from a file stored in an AWS S3 bucket:
    ...
    Example:
        ...
        # Create a datasource
        # To create a datasource from an existing datablob, create a new DataBlob
        # instance by passing the uuid of the existing datablob. Then, use that
        # datablob instance to create a new datasource.
        ds = db.to_datasource(
...
def delete(self: DataBlob) -> pd.DataFrame:
    ...
    Here's an example to delete a datablob from the server:
    ...
    Example:
        ...
        # Print the uuid of the newly created datablob
        print(db.uuid)

        # Delete an existing datablob from the server
        # In this case, a new instance of the DataBlob is created on purpose
        # to demonstrate that you can use uuid to delete any existing datablob.
        db_to_delete = DataBlob(db.uuid)
        db_to_delete.delete()

        # Check whether the datablob has been deleted
...
def tag(self: DataBlob, name: str) -> pd.DataFrame:
    ...
    Here's an example to tag a datablob:
    ...
    Example:
        ...
        # Print the tag set to the newly created datablob.
        print(db.details()["tags"][0])

        # Update the tag name for the datablob
        db.tag(name="{fill in tag_name}")
