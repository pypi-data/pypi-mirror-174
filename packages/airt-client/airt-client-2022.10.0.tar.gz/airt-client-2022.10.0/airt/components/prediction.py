...
def _add_example_to_docs(o: Any, example: str):

    original_doc = o.__doc__
    first_line, everything_else = original_doc.split("\n", 1)
    everything_else_dented = textwrap.dedent(everything_else)
    dented_original_doc = first_line + "\n" + everything_else_dented
    o.__doc__ = dented_original_doc + "\n" + textwrap.dedent(example)


# Internal Cell

_add_example_to_docs(Prediction, _docstring_example.__doc__)  # type: ignore
_add_example_to_docs(Prediction.ls, _docstring_example.__doc__)  # type: ignore
_add_example_to_docs(Prediction.as_df, _docstring_example.__doc__)  # type: ignore
...
_add_example_to_docs(Prediction.details, _docstring_example.__doc__)  # type: ignore
...
_add_example_to_docs(Prediction.delete, _docstring_example.__doc__)  # type: ignore
...
_add_example_to_docs(Prediction.to_pandas, _docstring_example.__doc__)  # type: ignore
...
_add_example_to_docs(Prediction.to_s3, _docstring_example.__doc__)  # type: ignore
...
_add_example_to_docs(Prediction.to_azure_blob_storage, _docstring_example.__doc__)  # type: ignore
...
_add_example_to_docs(Prediction.to_local, _docstring_example.__doc__)  # type: ignore
...
_add_example_to_docs(Prediction.to_mysql, _docstring_example.__doc__)  # type: ignore
...
_add_example_to_docs(Prediction.to_clickhouse, _docstring_example.__doc__)  # type: ignore
