...
class DataApp:
    ...
    def folium_chart(self, title: Optional[str] = None, folium: Optional[any] = None,
        ...
        """
        return FoliumChartWidget(title, folium, **additional)
    ...
    def table(self,
        ...
        param show_controls: show/hide header, header bold and rowcolumn controls
        return Table.
        """
        return TableWidget(data=data, cols=cols, rows_per_page=rows_per_page, show_controls=show_controls,
                           parent_data_app=self, **additional)
