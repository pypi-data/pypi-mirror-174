...
from pdkmaster.technology import (
    geometry as _geo, primitive as _prm,
)
...
class BandgapBranch2:
    ...
    def __init__(self, *,
        ...
        res = ckt.instantiate(resistor, name=f"res", height=r1_height)
...
class Bandgap:
    ...
    def __init__(self, *,
        ...
        r1 = ckt.instantiate(resistor, name="r1", height=r1_height)
        r2 = ckt.instantiate(resistor, name="r2bot", height=r2_height)
    ...
    def convert2cell(self, *,
        lib: _lbry.Library, cell_name: str, pnp_cell: _lbry._Cell,
    ) -> "BandgapCell":
        tech = lib.tech
...
class BandgapCell(_lbry._OnDemandCell):
    def __init__(self, *, lib: _lbry.Library, name: str,
        ...
        pnp: _lbry._Cell, pnp_mult:int=1, pnp_ratio: int,
    ):
    ...
    def _create_layout(self):
        ...
        for name in (
            ...
            info.layout.add_shape(prim=li, net=nets.vss, shape=shape)
        ...
        for pad_name in ("p1[0]_pad", "p2[0]_pad", "p3[0]_pad"):
            ...
            info.layout.add_shape(prim=psdm, net=None, shape=bb)
        ...
        for net in (nets.vdd, nets.vss, nets.vref):
            ...
            layouter.add_wire(net=net, wire=m1, pin=m1.pin[0], shape=bb)
