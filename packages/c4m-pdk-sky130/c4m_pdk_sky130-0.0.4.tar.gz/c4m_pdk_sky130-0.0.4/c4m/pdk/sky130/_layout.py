...
class _PlaceConstraint(_RefConstraint):
    ...
    def _get_bbs(self, *,
        ...
        for prim in tech.primitives.__iter_type__((
            _prm._WidthSpaceConductor, _prm.Via,
        )):
        ...
        for prim in tech.primitives.__iter_type__(_prm.Spacing):
            ...
            prims1 = cast(
                Iterable[_prm._Conductor],
                filter(lambda p: isinstance(p, _prm._Conductor), prim.primitives1),
            )
            if prim.primitives2 is not None:
                prims2 = cast(
                    Iterable[_prm._Conductor],
                    filter(lambda p: isinstance(p, _prm._Conductor), prim.primitives2),
                )
...
class _AlignConstraint(_RefConstraint):
    ...
    def __init__(self, *,
        info: "Sky130Layouter._PlaceInfo", ref_info: "Sky130Layouter._PlaceInfo",
        ref_pin: bool, prim: _prm._DesignMaskPrimitive, net: Optional[_ckt._CircuitNet],
    ) -> None:
        ...
    def __init__(self, *,
        info: "Sky130Layouter._PlaceInfo", ref_info: "Sky130Layouter._PlaceInfo",
        ref_pin: bool, prim: Optional[_prm._DesignMaskPrimitive],
    ...
    def get_bbs(self, *, placer: "Sky130Layouter") -> Tuple[_geo.Rect, _geo.Rect]:
        ...
        if self.prim is None:
            ...
            if not self.ref_pin:
                ...
                pin = cast(_prm._PinAttribute, self.prim).pin
                assert pin is not None
                other_bb = ref_info.bb(mask=pin[0].mask, net=self.net, depth=1)
            if other_bb is None:
                raise ValueError(
...
class _AlignAbsConstraint(_Constraint):
    def __init__(self, *,
        ...
        prim: Optional[_prm._DesignMaskPrimitive],
        net: Optional[_ckt._CircuitNet],
    ) -> None:
...
class Fill(_Constraint):
    def __init__(self, *,
        infos: Tuple["Sky130Layouter._PlaceInfo", ...], prim: _prm._DesignMaskPrimitive,
    ...
    def apply(self, *, placer: "Sky130Layouter") -> bool:
        ...
        placer.layouter.layout.add_shape(
            prim=self.prim, net=self.net, shape=shape,
        )
        return True
...
class Connect(_Constraint):
    def __init__(self, *,
        ...
        prim: _prm._WidthSpaceDesignMaskConductor, net: _ckt._CircuitNet,
    ) -> None:
...
class Extend(_Constraint):
    def __init__(self, *,
        info: "Sky130Layouter._PlaceInfo", ref_info: "Sky130Layouter._PlaceInfo",
        prim: _prm._DesignMaskPrimitive,
    ) -> None:
    ...
    def apply(self, *, placer: "Sky130Layouter") -> bool:
        ...
        placer.layouter.layout.add_shape(prim=self.prim, net=None, shape=shape)
        return True
...
class Sky130Layouter:
    ...
    """
    Object = Union[_ckt._Instance, _prm._Conductor]

    class _PlaceInfo(abc.ABC):
        def __init__(self, *,
            name: str, obj: "Sky130Layouter.Object", placer: "Sky130Layouter", layout: _lay._Layout,
        ) -> None:
            self.name = name
            self.obj = obj
            self.placer = placer
            self.layout = layout
            self.placed_layout: Optional[_lay._Layout] = None
    ...
    class _PlaceWireInfo(_PlaceInfo):
        def __init__(self, *,
            ...
            net: _ckt._CircuitNet, wire: _prm._Conductor,
            ...
            **wire_params,
            ...
            if ref_width is not None:
                ...
                if not ref_width_pin:
                    ...
                    pin = wire.pin[0]
                    bb = info.bb(mask=pin.mask, net=net)
                if bb is None:
                    raise ValueError(
        ...
        def wire_name(self) -> str:
            return self.name
        @property
        def wire(self) -> _prm._Conductor:
            return self.obj

    def __init__(self, *,
        layouter: _lay._CircuitLayouter, rotations: Dict[str, _geo.Rotation]={},
    ) -> None:
    ...
    def wire(self, *,
        wire_name: str, net: _ckt._CircuitNet, wire: _prm._Conductor,
    ...
    def _align(self, *,
        cls: Type[_AlignConstraint],
        name: str, ref_name: str, ref_pin: bool,
        prim: _prm._DesignMaskPrimitive, net: Optional[_ckt._CircuitNet]=None,
    ) -> None:
        ...
    def _align(self, *,
        cls: Type[_AlignConstraint],
    ...
    def fill(self, *,
        names: Iterable[str], prim: _prm._DesignMaskPrimitive,
        net: Optional[_ckt._CircuitNet]=None,
    ):
        infos = tuple(
    ...
    def extend(self, *,
        name: str, ref_name: str, prim: _prm._DesignMaskPrimitive,
    ):
        info = self.info_lookup[name]
        ref_info = self.info_lookup[ref_name]
