...
class _NPN_05v5_W1u00L1u00(_lbry._Cell):
    def __init__(self, *, lib: _lbry.Library, name: str):
        ...
        layout.add_shape(prim=licon, net=base, shape=shape)
        ...
        shape = _geo.Ring(outer_bound=outer, ring_width=0.41)
        layout.add_shape(prim=difftap, net=collector, shape=shape)
        ...
        layout.add_shape(prim=dnm, net=collector, shape=shape)
        ...
        layout.add_shape(prim=licon, net=collector, shape=shape)
...
class _NPN_05v5_W1u00L2u00(_lbry._Cell):
    def __init__(self, *, lib: _lbry.Library, name: str):
        super().__init__(lib=lib, name=name)
...
class _PNP_05v5_W0u68L0u68(_lbry._Cell):
    def __init__(self, *, lib: _lbry.Library, name: str):
        super().__init__(lib=lib, name=name)
...
class _PNP_05v5_W3u40L3u40(_lbry._Cell):
    def __init__(self, *, lib: _lbry.Library, name: str):
        super().__init__(lib=lib, name=name)
...
macrolib = _lbry.Library(name="MacroLib", tech=tech, cktfab=cktfab, layoutfab=layoutfab)
macrolib.cells += (
    _NPN_05v5_W1u00L1u00(lib=macrolib, name="NPN_05v5_W1u00L1u00"),
    _NPN_05v5_W1u00L2u00(lib=macrolib, name="NPN_05v5_W1u00L2u00"),
    _PNP_05v5_W0u68L0u68(lib=macrolib, name="PNP_05v5_W0u68L0u68"),
    _PNP_05v5_W3u40L3u40(lib=macrolib, name="PNP_05v5_W3u40L3u40"),
)
merge(macrolib)
