...
class ADC(_lbry._OnDemandCell):
    def __init__(self, *,
        lib: _lbry.Library, name: str,
        bits: int,
        ...
        cap: _prm.Capacitor, cap_unit_args: dict,
    ):
    ...
    def _create_layout(self):
        ...
        for cap_name in all_caps:
            ...
            info.layout.add_shape(prim=m4, net=nets.dac_caps_common, shape=shape)
        ...
        bb = info.bb(mask=poly.mask)
        assert bb is not None
        info.layout.add_shape(prim=psdm, shape=bb)
        placer.center_x(
