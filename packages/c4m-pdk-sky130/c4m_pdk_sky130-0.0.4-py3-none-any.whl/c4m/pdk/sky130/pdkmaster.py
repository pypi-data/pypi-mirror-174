...
class _Sky130(tch.Technology):
    ...
    def _init(self):
        ...
        prims += (
            ...
            *(
                prm.Resistor(name=name,
                    ...
                    sheetres=sheetres, model=model, # Own rule
                )
                for name, wire, marker, implant, sheetres, model in (
                    (
                        "ndiff_res", difftap, diffres, implants["nsdm"],
                        120.0, "sky130_fd_pr__res_generic_nd",
                    ),
                    (
                        "pdiff_res", difftap, diffres, implants["nsdm"],
                        197.0, "sky130_fd_pr__res_generic_pd",
                    ),
                    (
                        "poly_res", poly, polyres, None,
                        48.2, "sky130_fd_pr__res_generic_po",
                    ),
                )
            ),
            # capacitors
        ...
        bipolars =  tuple(
            prm.Bipolar(
                name=name, type_=type_, model=model, indicator=ind, is_subcircuit=True,
            ) for name, type_, model, ind in (
                ("npn_05v5_w1u00l1u00", "npn", "sky130_fd_pr__npn_05v5_W1p00L1p00", npn),
                ("npn_05v5_w1u00l2u00", "npn", "sky130_fd_pr__npn_05v5_W1p00L2p00", npn),
                ("pnp_05v5_w0u68l0u68", "pnp", "sky130_fd_pr__pnp_05v5_W0p68L0p68", pnp),
                ("pnp_05v5_w3u40l3u40", "pnp", "sky130_fd_pr__pnp_05v5_W3p40L3p40", pnp),
            )
        )
        prims += bipolars
