...
# the
from c4m.flexcell.library import _Cell as _FlexCell, Library as FlexCellLibrary
...
class VCOStage(_FlexCell):
    def __init__(self, *,
        lib: FlexCellLibrary, name: Optional[str]=None,
        ...
        if nmos is None:
            nmos = lib.canvas.nmos
        if pmos is None:
            pmos = lib.canvas.pmos
    ...
    def _create_layout(self):
        ...
        layout.add_shape(prim=li, net=nets.vctrl, shape=shape)
        layout.add_shape(prim=lipin, net=nets.vctrl, shape=shape)
        ...
        layout.add_shape(prim=li, net=nets.vin, shape=shape)
        layout.add_shape(prim=lipin, net=nets.vin, shape=shape)
        ...
        layout.add_shape(prim=lipin, net=nets.vout, shape=shape)
...
class VCOChain(_lbry._OnDemandCell):
    def __init__(self, *,
        lib: _lbry.Library, name: Optional[str]=None,
    ...
    def _create_layout(self):
        ...
        layout.add_shape(prim=m1, net=nets.vctrl, shape=shape)
        layout.add_shape(prim=m1pin, net=nets.vctrl, shape=shape)
        ...
        assert bb is not None
        layout.add_shape(prim=m1pin, net=nets.vin, shape=bb)
        ...
        assert bb is not None
        layout.add_shape(prim=m1pin, net=nets.vout, shape=bb)


class VCO(_lbry._OnDemandCell):
    def __init__(self, *,
        lib: _lbry.Library, name: Optional[str]=None,
        chain: VCOChain,
    ):
    ...
    def _create_layout(self):
        ...
        assert bb is not None
        layout.add_shape(prim=m1pin, net=nets.vctrl, shape=bb)
        ...
        assert bb2 is not None
        shape = _geo.Rect.from_rect(rect=bb1, right=bb2.right)
        layout.add_shape(prim=m1, net=nets.vout, shape=shape)
        layout.add_shape(prim=m1pin, net=nets.vout, shape=shape)


class Div2(_lbry._OnDemandCell):
    def __init__(self, *,
        lib: _lbry.Library, name: Optional[str]=None,
        ff: _lbry._Cell, inv: _lbry._Cell,
    ):
        if name is None:
            name = self.__class__.__name__
        super().__init__(lib=lib, name=name)
    ...
    def _create_layout(self):
        ...
        assert bb is not None
        layout.add_shape(prim=lipin, net=nets.sig, shape=bb)
        ...
        assert bb2 is not None
        shape = _geo.Rect.from_rect(rect=bb1, right=bb2.right)
        layout.add_shape(prim=m1, net=nets.div2, shape=shape)
        layout.add_shape(prim=m1pin, net=nets.div2, shape=shape)


class Div2Chain(_lbry._OnDemandCell):
    def __init__(self, *,
        lib: _lbry.Library, name: Optional[str]=None,
    ...
    def _create_layout(self):
        ...
        for n in range(self.n_stages):
            ...
            assert bb is not None
            layout.add_shape(prim=m1pin, net=net, shape=bb)
...
class OnPassGate(_FlexCell):
    ...
    def __init__(self, *,
        ...
        if npass is None:
            npass = lib.canvas.nmos
        if ppass is None:
            ppass = lib.canvas.pmos
    ...
    def _create_layout(self):
        ...
        assert bb2 is not None
        shape = _geo.Rect.from_rect(rect=bb1, top=bb2.top)
        layout.add_shape(prim=li, net=nets.i, shape=shape)
        layout.add_shape(prim=lipin, net=nets.i, shape=shape)
        ...
        assert bb2 is not None
        shape = _geo.Rect.from_rect(rect=bb1, top=bb2.top)
        layout.add_shape(prim=li, net=nets.o, shape=shape)
        layout.add_shape(prim=lipin, net=nets.o, shape=shape)
        ...
        layout.add_shape(prim=difftap, net=nets.o, shape=shape)
...
class PFD(_lbry._OnDemandCell):
    """Phase-frequency Detector"""
    def __init__(self, *,
        lib: _lbry.Library, name: Optional[str]=None,
        one: _lbry._Cell, ffr: _lbry._Cell,
        rstnand: _lbry._Cell, rstbuf: _lbry._Cell,
        refl_pass: OnPassGate, divl_inv: _lbry._Cell,
        down_nor2: _lbry._Cell, up_nand2: _lbry._Cell,
    ):
        if name is None:
            name = "PFD"
        super().__init__(lib=lib, name=name)
    ...
    def _create_layout(self):
        ...
        for net, cell_name in (
            ...
            assert bb is not None
            layout.add_shape(prim=lipin, net=net, shape=bb)
...
class CurrentLimit(_FlexCell):
    ...
    def _create_layout(self):
        ...
        layout.add_shape(prim=li, net=nets.drive, shape=shape)
        layout.add_shape(prim=lipin, net=nets.drive, shape=shape)
...
class ChargePumpFilter(_lbry._OnDemandCell):
    def __init__(self, *,
        lib: _lbry.Library, name: Optional[str]=None,
...
class PLL(_lbry._OnDemandCell):
    ...
    def _create_layout(self):
        ...
        layout.add_shape(prim=li, net=nets.up_n, shape=shape)
        ...
        cpf_cell = self.cpf
        cell_height = cpf_cell.cp.lib.canvas._cell_height
...
class SimVCOStage:
    ...
    def sim_delay(self, *,
        ...
        chain = VCOChain(lib=stage.lib, stage=stage, n_stages=13)
