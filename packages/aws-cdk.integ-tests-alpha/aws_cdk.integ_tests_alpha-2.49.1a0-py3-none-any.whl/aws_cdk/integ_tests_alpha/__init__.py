...
class AssertionsProvider(
    ...
    def grant_invoke(self, principal_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AssertionsProvider.grant_invoke)
...
class LambdaFunctionProviderProps:
    def __init__(self, *, handler: typing.Optional[builtins.str] = None) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LambdaFunctionProviderProps.__init__)
...
class WaiterStateMachine(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(WaiterStateMachine.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class WaiterStateMachineOptions:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(WaiterStateMachineOptions.__init__)
...
class WaiterStateMachineProps(WaiterStateMachineOptions):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(WaiterStateMachineProps.__init__)
            check_type(argname="argument backoff_rate", value=backoff_rate, expected_type=type_hints["backoff_rate"])
            check_type(argname="argument interval", value=interval, expected_type=type_hints["interval"])
            check_type(argname="argument total_timeout", value=total_timeout, expected_type=type_hints["total_timeout"])
        self._values: typing.Dict[str, typing.Any] = {}
...
class ApiCallBase(
    ...
    def _state_machine_arn(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ApiCallBase, "_state_machine_arn").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class AssertionsProviderProps(LambdaFunctionProviderProps):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AssertionsProviderProps.__init__)
            check_type(argname="argument handler", value=handler, expected_type=type_hints["handler"])
...
class AwsApiCall(
    ...
    def waiter_provider(self, value: typing.Optional[AssertionsProvider]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(AwsApiCall, "waiter_provider").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
