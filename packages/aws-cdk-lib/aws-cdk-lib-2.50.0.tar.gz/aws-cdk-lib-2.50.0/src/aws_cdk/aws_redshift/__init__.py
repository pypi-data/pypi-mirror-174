...
class CfnEndpointAccess(
    ...
    def vpc_endpoint(self, value: typing.Any) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnEndpointAccess, "vpc_endpoint").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def vpc_security_groups(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnEndpointAccess, "vpc_security_groups").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
