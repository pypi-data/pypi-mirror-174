...
class CfnBudget(
    ...
    class AutoAdjustDataProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnBudget.AutoAdjustDataProperty.__init__)
    ...
    class HistoricalOptionsProperty:
        def __init__(self, *, budget_adjustment_period: jsii.Number) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnBudget.HistoricalOptionsProperty.__init__)
