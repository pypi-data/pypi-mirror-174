...
class JsonPath(
    ...
    def array_contains(cls, array: typing.Any, value: typing.Any) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(JsonPath.array_contains)
    ...
    def array_get_item(cls, array: typing.Any, index: jsii.Number) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(JsonPath.array_get_item)
            check_type(argname="argument array", value=array, expected_type=type_hints["array"])
    ...
    def array_length(cls, array: typing.Any) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(JsonPath.array_length)
            check_type(argname="argument array", value=array, expected_type=type_hints["array"])
    ...
    def array_partition(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(JsonPath.array_partition)
            check_type(argname="argument array", value=array, expected_type=type_hints["array"])
    ...
    def array_range(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(JsonPath.array_range)
    ...
    def array_unique(cls, array: typing.Any) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(JsonPath.array_unique)
            check_type(argname="argument array", value=array, expected_type=type_hints["array"])
    ...
    def base64_decode(cls, base64: builtins.str) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(JsonPath.base64_decode)
    ...
    def base64_encode(cls, input: builtins.str) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(JsonPath.base64_encode)
    ...
    def hash(cls, data: typing.Any, algorithm: builtins.str) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(JsonPath.hash)
    ...
    def json_merge(cls, value1: typing.Any, value2: typing.Any) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(JsonPath.json_merge)
    ...
    def math_add(cls, num1: jsii.Number, num2: jsii.Number) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(JsonPath.math_add)
    ...
    def math_random(cls, start: jsii.Number, end: jsii.Number) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(JsonPath.math_random)
            check_type(argname="argument start", value=start, expected_type=type_hints["start"])
            check_type(argname="argument end", value=end, expected_type=type_hints["end"])
    ...
    def string_split(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(JsonPath.string_split)
...
class StateMachine(
    ...
    def from_state_machine_name(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StateMachine.from_state_machine_name)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument state_machine_name", value=state_machine_name, expected_type=type_hints["state_machine_name"])
