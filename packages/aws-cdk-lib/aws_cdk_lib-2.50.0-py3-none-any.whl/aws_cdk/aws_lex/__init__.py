...
class CfnBot(
    ...
    class AllowedInputTypesProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnBot.AllowedInputTypesProperty.__init__)
    ...
    class AudioAndDTMFInputSpecificationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnBot.AudioAndDTMFInputSpecificationProperty.__init__)
    ...
    class AudioSpecificationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnBot.AudioSpecificationProperty.__init__)
    ...
    class DTMFSpecificationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnBot.DTMFSpecificationProperty.__init__)
    ...
    class PromptAttemptSpecificationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnBot.PromptAttemptSpecificationProperty.__init__)
    ...
    class TextInputSpecificationProperty:
        def __init__(self, *, start_timeout_ms: jsii.Number) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnBot.TextInputSpecificationProperty.__init__)
                check_type(argname="argument start_timeout_ms", value=start_timeout_ms, expected_type=type_hints["start_timeout_ms"])
            self._values: typing.Dict[str, typing.Any] = {
                "start_timeout_ms": start_timeout_ms,
            }
