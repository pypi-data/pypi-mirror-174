...
class EcsBlueGreenDeploymentConfig:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EcsBlueGreenDeploymentConfig.__init__)
...
class EcsDeploymentGroupProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(EcsDeploymentGroupProps.__init__)
...
class EcsDeploymentGroup(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EcsDeploymentGroup.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_alarm(self, alarm: _IAlarm_ff3eabc0) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EcsDeploymentGroup.add_alarm)
            check_type(argname="argument alarm", value=alarm, expected_type=type_hints["alarm"])
        return typing.cast(None, jsii.invoke(self, "addAlarm", [alarm]))
