...
class Channel:
    ...
    def __init__(self, app, channel_type, channel_id=None):
        self._app = app
...
class ChannelPool:
    ...
    def _initialize_channel(self, channel_type, channel_id):
        ...
        channel_instance = channel_klazz(self._app, channel_type, channel_id)
    ...
    async def publish(self, message):
        ...
        print(message.data.get('channel'))
        channel_type, channel_id = self._get_type_and_id(channel)
        print(channel_type)
        print(channel_id)
        print("=======================")
...
async def initialize_channels(app):
    ...
    for name, options in app['settings'].CHANNELS.items():
        ...
        if create_on_startup:
            ...
            permanent_channels[name] = klazz(app, **options)
        else:
            types[name] = klazz
