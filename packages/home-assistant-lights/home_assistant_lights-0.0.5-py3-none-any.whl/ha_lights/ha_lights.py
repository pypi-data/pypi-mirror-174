...
class Factory:
    ...
    def AllLights(self):
        ...
        return namedtuple('Lights', lights)(*[Light(self.light_domain, x) for x in lights])

    def AllSwitches(self):
        switches = self.client.get_entities()['switch'].entities
        return namedtuple('Switches', switches)(*[Switch(self.switch_domain, x) for x in lights])
