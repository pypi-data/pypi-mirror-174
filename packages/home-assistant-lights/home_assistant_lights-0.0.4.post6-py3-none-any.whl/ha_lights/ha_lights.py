...
class Factory:
    ...
    def AllLights(self):
        ...
        return namedtuple('Lights', lights)(*[factory.MakeLight(x) for x in lights.values()])

    def AllSwitches(self):
        switches = self.client.get_entities()['switch'].entities
        return namedtuple('Switches', switches)(*[factory.MakeSwitch(x) for x in switches.values()])
