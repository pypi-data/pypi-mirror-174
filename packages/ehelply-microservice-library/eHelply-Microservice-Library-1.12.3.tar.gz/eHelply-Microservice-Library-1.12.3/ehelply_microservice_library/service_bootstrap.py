from typing import List, Union, Tuple, Callable, Type
...
from ehelply_microservice_library.integrations.monitor import Monitor, UsageType
from ehelply_microservice_library.integrations.ueri import Ueri
...
CONST_INTEGRATION_CONTENT: str = "content"
...
class ServiceBootstrap(Bootstrap):
    ...
    def get_usage_types(self) -> list[UsageType]:
        """
        List of up to date UsageTypes

        Returns:
            list[UsageType]: UsageType's supported by this service
        """
        return []
    ...
    def get_ueri_handlers(self) -> dict[str, Callable[[str], BaseModel | dict | list]]:
        return {}

    def get_ueri_custom_drill(self) -> Callable[[list[str], BaseModel | dict | list], any] | None:
        return None
    ...
    def get_fact_integration(self) -> Type[Fact]:
        return Fact
    ...
    def register_integrations(self):
        ...
        if CONST_INTEGRATION_CONTENT in active_integrations:
            subscribe_to_facts.append("ehelply-content")
        ...
        self.register_integration(self.get_fact_integration()(self.service_gatekeeper_key, State.logger, subscribe_to_facts))
        ...
        self.register_integration(Monitor(self.get_usage_types()))
        self.register_integration(Ueri(self.service_meta, self.get_ueri_handlers(), self.get_ueri_custom_drill()))
