...
class DynamicPrint(CsiStringMethods):
    """用于动态打印的类"""
    def __init__(self, scrwid=None, print_delay=0.012, csi_code='', step=1, is_wait=False, is_auto_reset=False,
    ...
    def print(self, *args, sep=' ', end='\n', csi_code=None, print_delay=None, step=None, is_wait=None,
    ...
    def pop_print_line(self, *args, csi_code=None, print_delay=None, step=None, sep=' ', end='\n',
...
class Choice(CsiStringMethods):
    def __init__(self,
        ...
        super().__init__(scrwid)
        """可直接通过属性设置的变量"""
        self.checked_csi_code = Colors256.BACK64 + Colors256.FORE255 + Style.BRIGHTs if checked_csi_code is None else checked_csi_code # 被选中效果
        self.unchecked_csi_code = Colors256.FORE255 + Style.DIMs if unchecked_csi_code is None else unchecked_csi_code  # 未选中效果
        self.click_csi_code = Colors256.BACK249 + Colors256.FORE232 if click_csi_code is None else click_csi_code  # 点击效果
