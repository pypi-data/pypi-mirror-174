...
class mainFormat(qtWidget.QWidget):
    ...
    def generalTabUI(self):
        ...
        _clone_hist_button = qtWidget.QPushButton(self)
        _clone_hist_button.setText('Mutation wave plot')
        _clone_hist_button.clicked.connect(self.mutWaveAction)
        _clone_hist_button = qtWidget.QPushButton(self)
        _clone_hist_button.setText('Fitness wave plot')
        _clone_hist_button.clicked.connect(self.fitWaveAction)
        _clone_hist_button = qtWidget.QPushButton(self)
        _clone_hist_button.setText('Clone plot')
        _clone_hist_button.clicked.connect(self.clonePlotAction)
