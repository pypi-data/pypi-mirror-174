    ...
    <div class="row align-items-center g-2 mb-2">
        <div class="col">
            <div class="input-group">
                ...
                <input type="text" :id="setting.id" :name="setting.name" class="form-control" v-model="my_data"
...
const regex_rules = {
    'filename': /^[\w\-_]*$/,
    'required filename': /^[\w\-_]+$/,
    'filepath': /^(^\/[\w\-_]+|(?![\s\S]))$/,
    'required filepath': /^\/[\w\-_]+$/,
    'integer': /^[0-9]*$/,
...
const validation_errors = {
    'filename': 'Must only contain characters { A-Z - _ }.',
    'required filename': 'Required, Must only contain characters { A-Z - _ }.',
    'filepath': 'Must start with / and only contain characters { A-Z - _ }.',
    'required filepath': 'Required, Must start with / and only contain characters { A-Z - _ }.',
