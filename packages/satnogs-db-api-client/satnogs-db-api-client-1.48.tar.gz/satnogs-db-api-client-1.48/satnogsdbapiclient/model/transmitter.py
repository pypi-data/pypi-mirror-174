...
class Transmitter(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, uuid, description, alive, mode, mode_id, uplink_mode, sat_id, norad_cat_id, norad_follow_id, updated, frequency_violation, *args, **kwargs):  # noqa: E501
