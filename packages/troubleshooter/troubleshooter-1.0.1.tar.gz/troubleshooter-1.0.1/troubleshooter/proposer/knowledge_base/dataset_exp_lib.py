...
dataset_experience_list_cn = [
    ...
    {
     "Fault Type": "batch操作报错",
     "Key Log Information": "Inconsistent batch shapes, batch operation expect same shape for each data row",
     "Key Python Stack Information": "",
     "Key C++ Stack Information": "",
    ...
    {
     "Fault Type": "GeneratorDataset使用自定义的Sampler错误",
    ...
    {
      "Fault Type": "自定义Iterable dataset索引报错",
    ...
    {
      "Fault Type": "自定义Dataset使用ops算子报错",
    ...
    {
     "Fault Type": "自定义python function数据增强函数的输入参数类型报错",
    ...
    {"Fault Type": "自定义python function数据增强函数的输出参数错误",
