...
operators_experience_list_cn = [
    ...
    {"Fault Type": "view/Reshape算子参数不匹配报错",
    ...
    {"Fault Type": "view/Reshape算子参数不匹配报错",
     "Key Log Information": "product of the 'input_x' shape should be equal to",
     "Key Python Stack Information": "",
     "Key C++ Stack Information": "",
    ...
    {"Fault Type": "SoftmaxCrossEntropyWithLogits接口使用报错",
