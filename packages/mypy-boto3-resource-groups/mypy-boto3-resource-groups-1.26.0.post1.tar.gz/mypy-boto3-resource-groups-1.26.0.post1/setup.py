...
setup(
    ...
    description=(
        "Type annotations for boto3.ResourceGroups 1.26.0 service generated with mypy-boto3-builder"
        " 7.11.10"
    ),
    classifiers=[
    ...
    package_data={"": ["LICENSE"], "mypy_boto3_resource_groups": ["py.typed", "*.pyi"]},
    python_requires=">=3.7",
    project_urls={
