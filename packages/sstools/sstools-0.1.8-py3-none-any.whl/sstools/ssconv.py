...
class SsConverter:
    def __init__(self):
        self._supported_rudolph_seasons = [2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022]
        # There is no Rudolphtabelle for 2021. 2021 bases on times swam 2019 too.
        self._rudolph_season_base = 2022  # 2022 bases on times swam 2021

        self._supported_fina_seasons = {'SCM': [2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022],
                                        'LCM': [2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022]
                                        }
        self._fina_season_base = {'SCM': 2022,  # Validity Period: 1.9.YYYY-31.8.YYYY+1
                                  'LCM': 2022}  # Validity Period: 1.1.XXXX-31.12.XXXX
    ...
    def get_finapts_from_seconds(self, course, gender, style, seconds, season_base=None):
        ...
        basetime = round(basetime, 2)  # round because str to frac is never precise
        if not basetime:
