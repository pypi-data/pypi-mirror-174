...
def fund_stock_holding_compare_china(fund,quarter1,quarter2,top=10):
    ...
    try:
        data = ak.fund_portfolio_hold_em(code=fund,year=years[0])
    except:
...
def compare_metf(fund_list,start,end,ftype='单位净值',graph=True):
    """
    功能：比较多只交易所基金的单位净值或累计净值
    """
...
if __name__=='__main__':
    ...
    fdf=compare_metf(fund_list,start,end,ftype='单位净值',graph=True)
#==============================================================================
#==============================================================================
#==============================================================================
