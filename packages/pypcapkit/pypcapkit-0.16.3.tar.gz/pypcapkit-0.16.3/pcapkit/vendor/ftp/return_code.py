...
def _walrus_wrapper_lambda_2a6bc068f05344b28eef5e57b9f123d4( NAME, DOCS, FLAG, ENUM, MODL):
    """Wrapper function for lambda definitions."""
    if False:
        name = NotImplemented

    def _walrus_wrapper_name_d9974df53996439c9ce69754f6672ebe(expr):
...
"""{(_walrus_wrapper_name_d9974df53996439c9ce69754f6672ebe(DOCS.split(' [', maxsplit=1)[0]))}
{'=' * (len(name) + 6)}
...
LINE =_walrus_wrapper_lambda_2a6bc068f05344b28eef5e57b9f123d4  # type: Callable[[str, str, str, str, str], str]
