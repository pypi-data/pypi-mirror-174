...
class Reassembly(Generic[PT, DT, IT, BT], metaclass=abc.ABCMeta):
    ...
    def count(self) -> 'int':
        ...
        def _walrus_wrapper_cached_f6cceac7477e487cb1c2b89475ada686(expr):
            """Wrapper function for assignment expression."""
            nonlocal cached
            cached = expr
            return cached
        if (_walrus_wrapper_cached_f6cceac7477e487cb1c2b89475ada686(self.__cached__.get('count'))) is not None:
            return cached
    ...
    def fetch(self) -> 'tuple[DT, ...]':
        ...
        *forcedly* obtain newly reassembled payload. Otherwise, the
        ...
        def _walrus_wrapper_cached_0e28120f85a7482f972285b39b09cc9a(expr):
            """Wrapper function for assignment expression."""
            nonlocal cached
            cached = expr
            return cached
        if (_walrus_wrapper_cached_0e28120f85a7482f972285b39b09cc9a(self.__cached__.get('fetch'))) is not None:
            return cached
