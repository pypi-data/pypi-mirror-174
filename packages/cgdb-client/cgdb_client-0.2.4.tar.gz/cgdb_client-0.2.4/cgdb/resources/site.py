class Site:
    ...
    def data_set_by_code(self, element, aggregation, time_step, level=None):
        return self._client._data_sets_manager.data_set_by_code(self, element, aggregation, time_step, level)
