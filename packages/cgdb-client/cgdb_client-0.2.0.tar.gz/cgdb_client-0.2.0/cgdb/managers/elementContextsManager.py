...
class ElementContextsManager(ManagerMix):
    ...
    def element_context_by_element(self, element_mark: str, aggregation: str, timestamp_code: str, level_code:str = None):
        ...
        for elementContext in self.elementContextsCached:
            if elementContext.aggregation == aggregation and elementContext.element.mark == element_mark and elementContext.time_step.code == timestamp_code and (level_code is not None and elementContext.levelId is not None and elementContext.level.code == level_code):
