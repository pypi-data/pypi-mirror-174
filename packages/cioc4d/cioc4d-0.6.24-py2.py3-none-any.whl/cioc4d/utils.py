    ...
    for asset in assets:
        ...
        if asset["owner"].GetType() == k.REDSHIFT_PROXY_TYPE:
            ...
            try:
                ...
                # unresolved is still True, so we may try other policies.
                

        if unresolved and asset["owner"].GetType() == k.REDSHIFT_TEXTURE_TYPE:
            ...
            # provide a validation step instead to warn them if we find proxy textueres that have
            # not been overridden.
