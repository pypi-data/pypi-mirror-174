...
from withpano.app.libraries import project_data_base_path
...
class UserCreate:
    def __init__(self, username):
        ...
        self.proj_base_path = f"{project_data_base_path}/{username}"
        self.user_enc_salt_file = f"{project_data_base_path}/_salt.key.withpano"
