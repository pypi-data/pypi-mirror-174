...
from aiovkapi.types.responses.base import BaseBoolInt, OkResponse
from aiovkapi.types.responses.messages import (
    CreateChatResponse,
...
class MessagesCategory(BaseCategory):
    async def add_chat_user(
        ...
        **kwargs
        ...
        response = await self.request("messages.addChatUser", params)
        model = OkResponse
    ...
    async def allow_messages_from_group(
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.allowMessagesFromGroup", params)
        model = OkResponse
        return model(**response).response
    ...
    async def create_chat(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.createChat", params)
    ...
    async def delete(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.delete", params)
    ...
    async def delete_chat_photo(
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.deleteChatPhoto", params)
    ...
    async def delete_conversation(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.deleteConversation", params)
    ...
    async def deny_messages_from_group(self, group_id: int, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.denyMessagesFromGroup", params)
        model = OkResponse
        return model(**response).response
    ...
    async def edit(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.edit", params)
        model = EditResponse
        return model(**response).response
    ...
    async def edit_chat(
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.editChat", params)
        model = OkResponse
        return model(**response).response
    ...
    async def get_by_conversation_message_id(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.getByConversationMessageId", params)
    ...
    async def get_chat_preview(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.getChatPreview", params)
    ...
    async def get_conversation_members(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.getConversationMembers", params)
    ...
    async def get_conversations(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.getConversations", params)
    ...
    async def get_conversations_by_id(
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.getConversationsById", params)
        model = self.get_model(
    ...
    async def get_history(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.getHistory", params)
        model = self.get_model(
    ...
    async def get_history_attachments(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.getHistoryAttachments", params)
    ...
    async def get_important_messages(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.getImportantMessages", params)
        model = self.get_model(
    ...
    async def get_intent_users(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.getIntentUsers", params)
    ...
    async def get_invite_link(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.getInviteLink", params)
    ...
    async def get_last_activity(self, user_id: int, **kwargs) -> MessagesLastActivity:
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.getLastActivity", params)
    ...
    async def get_long_poll_history(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.getLongPollHistory", params)
    ...
    async def get_long_poll_server(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.getLongPollServer", params)
    ...
    async def is_messages_from_group_allowed(
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.isMessagesFromGroupAllowed", params)
    ...
    async def join_chat_by_invite_link(
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.joinChatByInviteLink", params)
    ...
    async def mark_as_answered_conversation(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.markAsAnsweredConversation", params)
        model = OkResponse
        return model(**response).response
    ...
    async def mark_as_important(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.markAsImportant", params)
    ...
    async def mark_as_important_conversation(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.markAsImportantConversation", params)
        model = OkResponse
        return model(**response).response
    ...
    async def mark_as_read(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.markAsRead", params)
        model = OkResponse
        return model(**response).response
    ...
    async def pin(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.pin", params)
        model = PinResponse
        return model(**response).response
    ...
    async def remove_chat_user(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.removeChatUser", params)
        model = OkResponse
        return model(**response).response
    ...
    async def restore(
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.restore", params)
        model = OkResponse
        return model(**response).response
    ...
    async def search(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.search", params)
        model = self.get_model(
    ...
    async def search_conversations(
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.searchConversations", params)
        model = self.get_model(
    ...
    async def send(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.send", params)
        model = self.get_model(
    ...
    async def send_message_event_answer(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.sendMessageEventAnswer", params)
        model = OkResponse
        return model(**response).response
    ...
    async def set_activity(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.setActivity", params)
        model = OkResponse
        return model(**response).response
    ...
    async def set_chat_photo(self, file: str, **kwargs) -> SetChatPhotoResponseModel:
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.setChatPhoto", params)
    ...
    async def unpin(
        ...
        params = self.get_set_params(locals())
        response = await self.request("messages.unpin", params)
        model = OkResponse
        return model(**response).response
