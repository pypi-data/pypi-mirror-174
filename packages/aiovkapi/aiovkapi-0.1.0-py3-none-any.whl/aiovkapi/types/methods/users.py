...
from aiovkapi.types.responses.users import (
...
class UsersCategory(BaseCategory):
    ...
    async def get_followers(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("users.getFollowers", params)
    ...
    async def get_subscriptions(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("users.getSubscriptions", params)
        model = self.get_model(
    ...
    async def report(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("users.report", params)
        model = OkResponse
        return model(**response).response
    ...
    async def search(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("users.search", params)
