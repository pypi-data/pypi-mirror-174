...
from aiovkapi.types.responses.app_widgets import (
    AppWidgetsPhoto,
    AppWidgetsPhotos,
...
class AppWidgetsCategory(BaseCategory):
    async def get_app_image_upload_server(
        ...
        **kwargs
        ...
        response = await self.request("appWidgets.getAppImageUploadServer", params)
    ...
    async def get_app_images(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("appWidgets.getAppImages", params)
    ...
    async def get_group_image_upload_server(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("appWidgets.getGroupImageUploadServer", params)
    ...
    async def get_group_images(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("appWidgets.getGroupImages", params)
    ...
    async def get_images_by_id(
        ...
        params = self.get_set_params(locals())
        response = await self.request("appWidgets.getImagesById", params)
    ...
    async def save_app_image(self, hash: str, image: str, **kwargs) -> AppWidgetsPhoto:
        ...
        params = self.get_set_params(locals())
        response = await self.request("appWidgets.saveAppImage", params)
    ...
    async def save_group_image(
        ...
        params = self.get_set_params(locals())
        response = await self.request("appWidgets.saveGroupImage", params)
    ...
    async def update(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("appWidgets.update", params)
        model = OkResponse
        return model(**response).response
