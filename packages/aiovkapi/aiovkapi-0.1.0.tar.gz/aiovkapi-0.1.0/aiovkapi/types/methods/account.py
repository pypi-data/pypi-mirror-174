...
from aiovkapi.types.responses.account import (
...
class AccountCategory(BaseCategory):
    async def ban(self, owner_id: typing.Optional[int] = None, **kwargs) -> int:
        ...
        response = await self.request("account.ban", params)
        model = OkResponse
    ...
    async def change_password(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("account.changePassword", params)
    ...
    async def get_active_offers(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("account.getActiveOffers", params)
    ...
    async def get_app_permissions(self, user_id: int, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("account.getAppPermissions", params)
    ...
    async def get_banned(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("account.getBanned", params)
    ...
    async def get_counters(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("account.getCounters", params)
    ...
    async def get_info(
        ...
        params = self.get_set_params(locals())
        response = await self.request("account.getInfo", params)
    ...
    async def get_profile_info(self, **kwargs) -> AccountUserSettings:
        ...
        params = self.get_set_params(locals())
        response = await self.request("account.getProfileInfo", params)
    ...
    async def get_push_settings(
        ...
        params = self.get_set_params(locals())
        response = await self.request("account.getPushSettings", params)
    ...
    async def register_device(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("account.registerDevice", params)
        model = OkResponse
        return model(**response).response
    ...
    async def save_profile_info(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("account.saveProfileInfo", params)
    ...
    async def set_info(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("account.setInfo", params)
        model = OkResponse
        return model(**response).response
    ...
    async def set_offline(self, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("account.setOffline", params)
        model = OkResponse
        return model(**response).response
    ...
    async def set_online(self, voip: typing.Optional[bool] = None, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("account.setOnline", params)
        model = OkResponse
        return model(**response).response
    ...
    async def set_push_settings(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("account.setPushSettings", params)
        model = OkResponse
        return model(**response).response
    ...
    async def set_silence_mode(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("account.setSilenceMode", params)
        model = OkResponse
        return model(**response).response
    ...
    async def unban(self, owner_id: typing.Optional[int] = None, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("account.unban", params)
        model = OkResponse
        return model(**response).response
    ...
    async def unregister_device(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("account.unregisterDevice", params)
        model = OkResponse
        return model(**response).response
