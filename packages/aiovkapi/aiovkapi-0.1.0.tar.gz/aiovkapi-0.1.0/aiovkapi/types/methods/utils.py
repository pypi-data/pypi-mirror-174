...
from aiovkapi.types.responses.utils import (
    CheckLinkResponse,
...
class UtilsCategory(BaseCategory):
    async def check_link(self, url: str, **kwargs) -> UtilsLinkChecked:
        ...
        response = await self.request("utils.checkLink", params)
    ...
    async def delete_from_last_shortened(self, key: str, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("utils.deleteFromLastShortened", params)
        model = OkResponse
        return model(**response).response
    ...
    async def get_last_shortened_links(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("utils.getLastShortenedLinks", params)
    ...
    async def get_link_stats(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("utils.getLinkStats", params)
    ...
    async def get_server_time(self, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("utils.getServerTime", params)
    ...
    async def get_short_link(
        ...
        params = self.get_set_params(locals())
        response = await self.request("utils.getShortLink", params)
    ...
    async def resolve_screen_name(
        ...
        params = self.get_set_params(locals())
        response = await self.request("utils.resolveScreenName", params)
