...
from aiovkapi.types.responses.store import (
    BaseSticker,
...
class StoreCategory(BaseCategory):
    async def add_stickers_to_favorite(
        ...
        response = await self.request("store.addStickersToFavorite", params)
        model = OkResponse
    ...
    async def get_favorite_stickers(self, **kwargs) -> typing.List[BaseSticker]:
        ...
        params = self.get_set_params(locals())
        response = await self.request("store.getFavoriteStickers", params)
    ...
    async def get_products(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("store.getProducts", params)
    ...
    async def get_stickers_keywords(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("store.getStickersKeywords", params)
    ...
    async def remove_stickers_from_favorite(
        ...
        params = self.get_set_params(locals())
        response = await self.request("store.removeStickersFromFavorite", params)
        model = OkResponse
        return model(**response).response
