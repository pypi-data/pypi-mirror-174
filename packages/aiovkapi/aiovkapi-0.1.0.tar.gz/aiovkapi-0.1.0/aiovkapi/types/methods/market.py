...
from aiovkapi.types.responses.market import (
    AddAlbumResponse,
...
class MarketCategory(BaseCategory):
    async def add(
        ...
        **kwargs
        ...
        response = await self.request("market.add", params)
        model = AddResponse
    ...
    async def add_album(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.addAlbum", params)
    ...
    async def add_to_album(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.addToAlbum", params)
        model = OkResponse
        return model(**response).response
    ...
    async def create_comment(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.createComment", params)
    ...
    async def delete(self, owner_id: int, item_id: int, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.delete", params)
        model = OkResponse
        return model(**response).response
    ...
    async def delete_album(self, owner_id: int, album_id: int, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.deleteAlbum", params)
        model = OkResponse
        return model(**response).response
    ...
    async def delete_comment(
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.deleteComment", params)
    ...
    async def edit(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.edit", params)
        model = OkResponse
        return model(**response).response
    ...
    async def edit_album(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.editAlbum", params)
        model = OkResponse
        return model(**response).response
    ...
    async def edit_comment(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.editComment", params)
        model = OkResponse
        return model(**response).response
    ...
    async def edit_order(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.editOrder", params)
        model = OkResponse
        return model(**response).response
    ...
    async def get(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.get", params)
    ...
    async def get_album_by_id(
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.getAlbumById", params)
    ...
    async def get_albums(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.getAlbums", params)
    ...
    async def get_by_id(
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.getById", params)
        model = self.get_model(
    ...
    async def get_categories(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.getCategories", params)
    ...
    async def get_comments(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.getComments", params)
    ...
    async def get_group_orders(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.getGroupOrders", params)
    ...
    async def get_order_by_id(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.getOrderById", params)
    ...
    async def get_order_items(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.getOrderItems", params)
    ...
    async def get_orders(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.getOrders", params)
        model = self.get_model(
    ...
    async def remove_from_album(
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.removeFromAlbum", params)
        model = OkResponse
        return model(**response).response
    ...
    async def reorder_albums(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.reorderAlbums", params)
        model = OkResponse
        return model(**response).response
    ...
    async def reorder_items(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.reorderItems", params)
        model = OkResponse
        return model(**response).response
    ...
    async def report(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.report", params)
        model = OkResponse
        return model(**response).response
    ...
    async def report_comment(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.reportComment", params)
        model = OkResponse
        return model(**response).response
    ...
    async def restore(self, owner_id: int, item_id: int, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.restore", params)
        model = OkResponse
        return model(**response).response
    ...
    async def restore_comment(
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.restoreComment", params)
    ...
    async def search(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.search", params)
        model = self.get_model(
    ...
    async def search_items(
        ...
        price_from: typing.Optional[int] = None,
        price_to: typing.Optional[int] = None,
        sort_by: typing.Optional[Literal[2, 3, 1]] = None,
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("market.searchItems", params)
