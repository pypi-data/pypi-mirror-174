...
from aiovkapi.types.responses.wall import (
...
class WallCategory(BaseCategory):
    async def check_copyright_link(self, link: str, **kwargs) -> BaseBoolInt:
        ...
        response = await self.request("wall.checkCopyrightLink", params)
        model = BoolResponse
    ...
    async def close_comments(
        ...
        params = self.get_set_params(locals())
        response = await self.request("wall.closeComments", params)
        model = BoolResponse
        return model(**response).response
    ...
    async def create_comment(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("wall.createComment", params)
    ...
    async def delete(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("wall.delete", params)
        model = OkResponse
        return model(**response).response
    ...
    async def delete_comment(
        ...
        params = self.get_set_params(locals())
        response = await self.request("wall.deleteComment", params)
        model = OkResponse
        return model(**response).response
    ...
    async def edit(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("wall.edit", params)
        model = EditResponse
        return model(**response).response
    ...
    async def edit_ads_stealth(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("wall.editAdsStealth", params)
        model = OkResponse
        return model(**response).response
    ...
    async def edit_comment(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("wall.editComment", params)
        model = OkResponse
        return model(**response).response
    ...
    async def get_by_id(
        ...
        params = self.get_set_params(locals())
        response = await self.request("wall.getById", params)
        model = self.get_model(
    ...
    async def get_comment(
        ...
        params = self.get_set_params(locals())
        response = await self.request("wall.getComment", params)
        model = self.get_model(
    ...
    async def get_comments(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("wall.getComments", params)
        model = self.get_model(
    ...
    async def get_reposts(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("wall.getReposts", params)
    ...
    async def open_comments(self, owner_id: int, post_id: int, **kwargs) -> BaseBoolInt:
        ...
        params = self.get_set_params(locals())
        response = await self.request("wall.openComments", params)
        model = BoolResponse
        return model(**response).response
    ...
    async def pin(
        ...
        params = self.get_set_params(locals())
        response = await self.request("wall.pin", params)
        model = OkResponse
        return model(**response).response
    ...
    async def post(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("wall.post", params)
        model = PostResponse
        return model(**response).response
    ...
    async def post_ads_stealth(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("wall.postAdsStealth", params)
    ...
    async def report_comment(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("wall.reportComment", params)
        model = OkResponse
        return model(**response).response
    ...
    async def report_post(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("wall.reportPost", params)
        model = OkResponse
        return model(**response).response
    ...
    async def repost(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("wall.repost", params)
    ...
    async def restore(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("wall.restore", params)
        model = OkResponse
        return model(**response).response
    ...
    async def restore_comment(
        ...
        params = self.get_set_params(locals())
        response = await self.request("wall.restoreComment", params)
        model = OkResponse
        return model(**response).response
    ...
    async def search(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("wall.search", params)
        model = self.get_model(
    ...
    async def unpin(
        ...
        params = self.get_set_params(locals())
        response = await self.request("wall.unpin", params)
        model = OkResponse
        return model(**response).response
