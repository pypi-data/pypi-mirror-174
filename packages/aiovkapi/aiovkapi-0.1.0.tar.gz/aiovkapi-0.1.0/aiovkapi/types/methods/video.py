...
from aiovkapi.types.responses.video import (
    AddAlbumResponse,
...
class VideoCategory(BaseCategory):
    async def add(
        ...
        **kwargs
        ...
        response = await self.request("video.add", params)
        model = OkResponse
    ...
    async def add_album(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("video.addAlbum", params)
    ...
    async def add_to_album(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("video.addToAlbum", params)
    ...
    async def create_comment(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("video.createComment", params)
    ...
    async def delete(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("video.delete", params)
        model = OkResponse
        return model(**response).response
    ...
    async def delete_album(
        ...
        params = self.get_set_params(locals())
        response = await self.request("video.deleteAlbum", params)
        model = OkResponse
        return model(**response).response
    ...
    async def delete_comment(
        ...
        params = self.get_set_params(locals())
        response = await self.request("video.deleteComment", params)
        model = OkResponse
        return model(**response).response
    ...
    async def edit(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("video.edit", params)
        model = OkResponse
        return model(**response).response
    ...
    async def edit_album(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("video.editAlbum", params)
        model = OkResponse
        return model(**response).response
    ...
    async def edit_comment(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("video.editComment", params)
        model = OkResponse
        return model(**response).response
    ...
    async def get(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("video.get", params)
        model = GetResponse
        return model(**response).response
    ...
    async def get_album_by_id(
        ...
        params = self.get_set_params(locals())
        response = await self.request("video.getAlbumById", params)
    ...
    async def get_albums(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("video.getAlbums", params)
        model = self.get_model(
    ...
    async def get_albums_by_video(
        ...
        params = self.get_set_params(locals())
        response = await self.request("video.getAlbumsByVideo", params)
        model = self.get_model(
    ...
    async def get_comments(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("video.getComments", params)
        model = self.get_model(
    ...
    async def remove_from_album(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("video.removeFromAlbum", params)
        model = self.get_model(
            ((("multi",), ChangeVideoAlbumsResponse),),
            default=OkResponse,
            params=params,
    ...
    async def reorder_albums(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("video.reorderAlbums", params)
        model = OkResponse
        return model(**response).response
    ...
    async def reorder_videos(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("video.reorderVideos", params)
        model = OkResponse
        return model(**response).response
    ...
    async def report(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("video.report", params)
        model = OkResponse
        return model(**response).response
    ...
    async def report_comment(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("video.reportComment", params)
        model = OkResponse
        return model(**response).response
    ...
    async def restore(
        ...
        params = self.get_set_params(locals())
        response = await self.request("video.restore", params)
        model = OkResponse
        return model(**response).response
    ...
    async def restore_comment(
        ...
        params = self.get_set_params(locals())
        response = await self.request("video.restoreComment", params)
    ...
    async def save(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("video.save", params)
        model = SaveResponse
        return model(**response).response
    ...
    async def search(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("video.search", params)
        model = self.get_model(
