...
from aiovkapi.types.responses.pretty_cards import (
    CreateResponse,
    CreateResponseModel,
    DeleteResponse,
    DeleteResponseModel,
...
class PrettyCardsCategory(BaseCategory):
    async def create(
        ...
        **kwargs
        ...
        response = await self.request("prettyCards.create", params)
    ...
    async def delete(
        ...
        params = self.get_set_params(locals())
        response = await self.request("prettyCards.delete", params)
    ...
    async def edit(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("prettyCards.edit", params)
        model = EditResponse
        return model(**response).response
    ...
    async def get(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("prettyCards.get", params)
        model = GetResponse
        return model(**response).response
    ...
    async def get_by_id(
        ...
        params = self.get_set_params(locals())
        response = await self.request("prettyCards.getById", params)
    ...
    async def get_upload_url(self, **kwargs) -> str:
        ...
        params = self.get_set_params(locals())
        response = await self.request("prettyCards.getUploadURL", params)
