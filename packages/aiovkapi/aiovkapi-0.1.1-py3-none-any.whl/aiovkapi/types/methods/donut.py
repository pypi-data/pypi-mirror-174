...
from aiovkapi.types.responses.base import BaseBoolInt, BoolResponse
from aiovkapi.types.responses.donut import (
...
class DonutCategory(BaseCategory):
    async def get_friends(
        ...
        **kwargs
        ...
        response = await self.request("donut.getFriends", params)
    ...
    async def get_subscription(
        ...
        params = self.get_set_params(locals())
        response = await self.request("donut.getSubscription", params)
    ...
    async def get_subscriptions(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("donut.getSubscriptions", params)
    ...
    async def is_don(self, owner_id: int, **kwargs) -> BaseBoolInt:
        ...
        params = self.get_set_params(locals())
        response = await self.request("donut.isDon", params)
        model = BoolResponse
        return model(**response).response
