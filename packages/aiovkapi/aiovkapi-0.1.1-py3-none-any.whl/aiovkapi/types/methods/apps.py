...
from aiovkapi.types.responses.apps import (
    AppsCatalogList,
    GetCatalogResponse,
...
class AppsCategory(BaseCategory):
    async def delete_app_requests(self, **kwargs) -> int:
        ...
        response = await self.request("apps.deleteAppRequests", params)
        model = OkResponse
    ...
    async def get(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("apps.get", params)
        model = GetResponse
        return model(**response).response
    ...
    async def get_catalog(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("apps.getCatalog", params)
    ...
    async def get_friends_list(
        ...
        params = self.get_set_params(locals())
        response = await self.request("apps.getFriendsList", params)
    ...
    async def get_leaderboard(
        ...
        params = self.get_set_params(locals())
        response = await self.request("apps.getLeaderboard", params)
        model = self.get_model(
    ...
    async def get_mini_app_policies(
        ...
        params = self.get_set_params(locals())
        response = await self.request("apps.getMiniAppPolicies", params)
    ...
    async def get_scopes(
        ...
        params = self.get_set_params(locals())
        response = await self.request("apps.getScopes", params)
    ...
    async def get_score(self, user_id: int, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("apps.getScore", params)
    ...
    async def promo_has_active_gift(
        ...
        params = self.get_set_params(locals())
        response = await self.request("apps.promoHasActiveGift", params)
        model = BoolResponse
        return model(**response).response
    ...
    async def promo_use_gift(
        ...
        params = self.get_set_params(locals())
        response = await self.request("apps.promoUseGift", params)
        model = BoolResponse
        return model(**response).response
    ...
    async def send_request(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("apps.sendRequest", params)
