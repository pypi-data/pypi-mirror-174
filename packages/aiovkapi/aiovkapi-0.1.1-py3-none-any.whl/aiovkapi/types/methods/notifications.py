...
from aiovkapi.types.responses.notifications import (
    GetResponse,
    GetResponseModel,
...
class NotificationsCategory(BaseCategory):
    async def get(
        ...
        **kwargs
        ...
        response = await self.request("notifications.get", params)
        model = GetResponse
    ...
    async def mark_as_viewed(self, **kwargs) -> BaseBoolInt:
        ...
        params = self.get_set_params(locals())
        response = await self.request("notifications.markAsViewed", params)
    ...
    async def send_message(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("notifications.sendMessage", params)
