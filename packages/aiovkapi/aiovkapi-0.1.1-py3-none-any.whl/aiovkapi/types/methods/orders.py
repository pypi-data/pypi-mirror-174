...
from aiovkapi.types.responses.base import BaseBoolInt
from aiovkapi.types.responses.orders import (
...
class OrdersCategory(BaseCategory):
    async def cancel_subscription(
        ...
        **kwargs
        ...
        response = await self.request("orders.cancelSubscription", params)
    ...
    async def change_state(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("orders.changeState", params)
    ...
    async def get(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("orders.get", params)
        model = GetResponse
        return model(**response).response
    ...
    async def get_amount(
        ...
        params = self.get_set_params(locals())
        response = await self.request("orders.getAmount", params)
    ...
    async def get_by_id(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("orders.getById", params)
    ...
    async def get_user_subscription_by_id(
        ...
        params = self.get_set_params(locals())
        response = await self.request("orders.getUserSubscriptionById", params)
    ...
    async def get_user_subscriptions(
        ...
        params = self.get_set_params(locals())
        response = await self.request("orders.getUserSubscriptions", params)
    ...
    async def update_subscription(
        ...
        params = self.get_set_params(locals())
        response = await self.request("orders.updateSubscription", params)
