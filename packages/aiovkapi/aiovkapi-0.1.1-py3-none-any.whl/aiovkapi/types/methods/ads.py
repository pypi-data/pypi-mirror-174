...
from aiovkapi.types.responses.ads import (
...
class AdsCategory(BaseCategory):
    async def add_office_users(self, account_id: int, data: str, **kwargs) -> bool:
        ...
        response = await self.request("ads.addOfficeUsers", params)
    ...
    async def check_link(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.checkLink", params)
    ...
    async def create_ads(
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.createAds", params)
    ...
    async def create_campaigns(
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.createCampaigns", params)
    ...
    async def create_clients(
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.createClients", params)
    ...
    async def create_target_group(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.createTargetGroup", params)
    ...
    async def delete_ads(self, account_id: int, ids: str, **kwargs) -> typing.List[int]:
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.deleteAds", params)
    ...
    async def delete_campaigns(
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.deleteCampaigns", params)
    ...
    async def delete_clients(
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.deleteClients", params)
    ...
    async def delete_target_group(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.deleteTargetGroup", params)
        model = OkResponse
        return model(**response).response
    ...
    async def get_accounts(self, **kwargs) -> typing.List[AdsAccount]:
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.getAccounts", params)
    ...
    async def get_ads(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.getAds", params)
    ...
    async def get_ads_layout(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.getAdsLayout", params)
    ...
    async def get_ads_targeting(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.getAdsTargeting", params)
    ...
    async def get_budget(self, account_id: int, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.getBudget", params)
    ...
    async def get_campaigns(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.getCampaigns", params)
    ...
    async def get_categories(
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.getCategories", params)
    ...
    async def get_clients(self, account_id: int, **kwargs) -> typing.List[AdsClient]:
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.getClients", params)
    ...
    async def get_demographics(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.getDemographics", params)
    ...
    async def get_flood_stats(self, account_id: int, **kwargs) -> AdsFloodStats:
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.getFloodStats", params)
    ...
    async def get_lookalike_requests(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.getLookalikeRequests", params)
    ...
    async def get_musicians(
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.getMusicians", params)
    ...
    async def get_musicians_by_ids(
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.getMusiciansByIds", params)
        model = GetMusiciansResponse
        return model(**response).response
    ...
    async def get_office_users(
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.getOfficeUsers", params)
    ...
    async def get_posts_reach(
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.getPostsReach", params)
    ...
    async def get_rejection_reason(
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.getRejectionReason", params)
    ...
    async def get_statistics(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.getStatistics", params)
    ...
    async def get_suggestions(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.getSuggestions", params)
    ...
    async def get_target_groups(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.getTargetGroups", params)
    ...
    async def get_targeting_stats(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.getTargetingStats", params)
    ...
    async def get_upload_url(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.getUploadURL", params)
    ...
    async def get_video_upload_url(self, **kwargs) -> str:
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.getVideoUploadURL", params)
    ...
    async def import_target_contacts(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.importTargetContacts", params)
    ...
    async def remove_office_users(self, account_id: int, ids: str, **kwargs) -> bool:
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.removeOfficeUsers", params)
    ...
    async def update_ads(
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.updateAds", params)
    ...
    async def update_campaigns(self, account_id: int, data: str, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.updateCampaigns", params)
    ...
    async def update_clients(self, account_id: int, data: str, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.updateClients", params)
    ...
    async def update_office_users(
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.updateOfficeUsers", params)
    ...
    async def update_target_group(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("ads.updateTargetGroup", params)
        model = OkResponse
        return model(**response).response
