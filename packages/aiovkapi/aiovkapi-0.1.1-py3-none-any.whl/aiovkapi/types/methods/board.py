...
from aiovkapi.types.responses.board import (
    AddTopicResponse,
...
class BoardCategory(BaseCategory):
    async def add_topic(
        ...
        **kwargs
        ...
        response = await self.request("board.addTopic", params)
    ...
    async def close_topic(self, group_id: int, topic_id: int, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("board.closeTopic", params)
        model = OkResponse
        return model(**response).response
    ...
    async def create_comment(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("board.createComment", params)
    ...
    async def delete_comment(
        ...
        params = self.get_set_params(locals())
        response = await self.request("board.deleteComment", params)
        model = OkResponse
        return model(**response).response
    ...
    async def delete_topic(self, group_id: int, topic_id: int, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("board.deleteTopic", params)
        model = OkResponse
        return model(**response).response
    ...
    async def edit_comment(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("board.editComment", params)
        model = OkResponse
        return model(**response).response
    ...
    async def edit_topic(
        ...
        params = self.get_set_params(locals())
        response = await self.request("board.editTopic", params)
        model = OkResponse
        return model(**response).response
    ...
    async def fix_topic(self, group_id: int, topic_id: int, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("board.fixTopic", params)
        model = OkResponse
        return model(**response).response
    ...
    async def get_comments(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("board.getComments", params)
    ...
    async def get_topics(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("board.getTopics", params)
        model = self.get_model(
    ...
    async def open_topic(self, group_id: int, topic_id: int, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("board.openTopic", params)
        model = OkResponse
        return model(**response).response
    ...
    async def restore_comment(
        ...
        params = self.get_set_params(locals())
        response = await self.request("board.restoreComment", params)
        model = OkResponse
        return model(**response).response
    ...
    async def unfix_topic(self, group_id: int, topic_id: int, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("board.unfixTopic", params)
        model = OkResponse
        return model(**response).response
