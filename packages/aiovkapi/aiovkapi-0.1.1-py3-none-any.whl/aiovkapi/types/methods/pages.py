...
from aiovkapi.types.responses.pages import (
    GetHistoryResponse,
    GetResponse,
    GetTitlesResponse,
    GetVersionResponse,
...
class PagesCategory(BaseCategory):
    async def clear_cache(self, url: str, **kwargs) -> int:
        ...
        response = await self.request("pages.clearCache", params)
        model = OkResponse
    ...
    async def get(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("pages.get", params)
        model = GetResponse
        return model(**response).response
    ...
    async def get_history(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("pages.getHistory", params)
    ...
    async def get_titles(
        ...
        params = self.get_set_params(locals())
        response = await self.request("pages.getTitles", params)
    ...
    async def get_version(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("pages.getVersion", params)
    ...
    async def parse_wiki(
        ...
        params = self.get_set_params(locals())
        response = await self.request("pages.parseWiki", params)
    ...
    async def save(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("pages.save", params)
        model = SaveResponse
        return model(**response).response
    ...
    async def save_access(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("pages.saveAccess", params)
