...
from aiovkapi.types.responses.base import BaseGetUploadServerResponse, OkResponse
from aiovkapi.types.responses.docs import (
    AddResponse,
    BaseUploadServer,
    DocsDoc,
    GetByIdResponse,
...
class DocsCategory(BaseCategory):
    async def add(
        ...
        **kwargs
        ...
        response = await self.request("docs.add", params)
        model = AddResponse
    ...
    async def delete(self, owner_id: int, doc_id: int, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("docs.delete", params)
        model = OkResponse
        return model(**response).response
    ...
    async def edit(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("docs.edit", params)
        model = OkResponse
        return model(**response).response
    ...
    async def get(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("docs.get", params)
        model = GetResponse
        return model(**response).response
    ...
    async def get_by_id(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("docs.getById", params)
    ...
    async def get_messages_upload_server(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("docs.getMessagesUploadServer", params)
    ...
    async def get_types(self, owner_id: int, **kwargs) -> GetTypesResponseModel:
        ...
        params = self.get_set_params(locals())
        response = await self.request("docs.getTypes", params)
    ...
    async def get_upload_server(
        ...
        params = self.get_set_params(locals())
        response = await self.request("docs.getUploadServer", params)
        model = GetUploadServerResponse
        return model(**response).response
    ...
    async def get_wall_upload_server(
        ...
        params = self.get_set_params(locals())
        response = await self.request("docs.getWallUploadServer", params)
    ...
    async def save(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("docs.save", params)
        model = SaveResponse
        return model(**response).response
    ...
    async def search(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("docs.search", params)
