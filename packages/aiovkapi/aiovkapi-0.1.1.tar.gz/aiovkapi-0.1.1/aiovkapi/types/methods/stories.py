...
from aiovkapi.types.responses.stories import (
...
class StoriesCategory(BaseCategory):
    async def ban_owner(self, owners_ids: typing.List[int], **kwargs) -> int:
        ...
        response = await self.request("stories.banOwner", params)
        model = OkResponse
    ...
    async def delete(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("stories.delete", params)
        model = OkResponse
        return model(**response).response
    ...
    async def get(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("stories.get", params)
    ...
    async def get_banned(
        ...
        params = self.get_set_params(locals())
        response = await self.request("stories.getBanned", params)
    ...
    async def get_by_id(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("stories.getById", params)
    ...
    async def get_photo_upload_server(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("stories.getPhotoUploadServer", params)
    ...
    async def get_replies(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("stories.getReplies", params)
        model = GetV5113Response
        return model(**response).response
    ...
    async def get_stats(
        ...
        params = self.get_set_params(locals())
        response = await self.request("stories.getStats", params)
    ...
    async def get_video_upload_server(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("stories.getVideoUploadServer", params)
    ...
    async def get_viewers(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("stories.getViewers", params)
        model = self.get_model(
    ...
    async def hide_all_replies(
        ...
        params = self.get_set_params(locals())
        response = await self.request("stories.hideAllReplies", params)
        model = OkResponse
        return model(**response).response
    ...
    async def hide_reply(self, owner_id: int, story_id: int, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("stories.hideReply", params)
        model = OkResponse
        return model(**response).response
    ...
    async def save(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("stories.save", params)
        model = SaveResponse
        return model(**response).response
    ...
    async def search(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("stories.search", params)
        model = GetV5113Response
        return model(**response).response
    ...
    async def send_interaction(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("stories.sendInteraction", params)
        model = OkResponse
        return model(**response).response
    ...
    async def unban_owner(self, owners_ids: typing.List[int], **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("stories.unbanOwner", params)
        model = OkResponse
        return model(**response).response
