...
from aiovkapi.types.responses.base import BaseBoolInt, BoolResponse, OkResponse
from aiovkapi.types.responses.groups import (
    AddAddressResponse,
...
class GroupsCategory(BaseCategory):
    async def add_address(
        ...
        **kwargs
        ...
        response = await self.request("groups.addAddress", params)
    ...
    async def add_callback_server(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.addCallbackServer", params)
    ...
    async def add_link(
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.addLink", params)
    ...
    async def approve_request(self, group_id: int, user_id: int, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.approveRequest", params)
        model = OkResponse
        return model(**response).response
    ...
    async def ban(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.ban", params)
        model = OkResponse
        return model(**response).response
    ...
    async def create(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.create", params)
    ...
    async def delete_address(self, group_id: int, address_id: int, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.deleteAddress", params)
        model = OkResponse
        return model(**response).response
    ...
    async def delete_callback_server(
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.deleteCallbackServer", params)
        model = OkResponse
        return model(**response).response
    ...
    async def delete_link(self, group_id: int, link_id: int, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.deleteLink", params)
        model = OkResponse
        return model(**response).response
    ...
    async def disable_online(self, group_id: int, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.disableOnline", params)
        model = OkResponse
        return model(**response).response
    ...
    async def edit(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.edit", params)
        model = OkResponse
        return model(**response).response
    ...
    async def edit_address(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.editAddress", params)
    ...
    async def edit_callback_server(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.editCallbackServer", params)
        model = OkResponse
        return model(**response).response
    ...
    async def edit_link(
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.editLink", params)
        model = OkResponse
        return model(**response).response
    ...
    async def edit_manager(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.editManager", params)
        model = OkResponse
        return model(**response).response
    ...
    async def enable_online(self, group_id: int, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.enableOnline", params)
        model = OkResponse
        return model(**response).response
    ...
    async def get(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.get", params)
    ...
    async def get_addresses(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.getAddresses", params)
    ...
    async def get_banned(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.getBanned", params)
    ...
    async def get_callback_confirmation_code(
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.getCallbackConfirmationCode", params)
    ...
    async def get_callback_servers(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.getCallbackServers", params)
    ...
    async def get_callback_settings(
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.getCallbackSettings", params)
    ...
    async def get_catalog(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.getCatalog", params)
    ...
    async def get_catalog_info(
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.getCatalogInfo", params)
        model = self.get_model(
    ...
    async def get_invited_users(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.getInvitedUsers", params)
    ...
    async def get_invites(
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.getInvites", params)
        model = self.get_model(
    ...
    async def get_long_poll_server(
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.getLongPollServer", params)
    ...
    async def get_long_poll_settings(
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.getLongPollSettings", params)
    ...
    async def get_members(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.getMembers", params)
        model = self.get_model(
            (
    ...
    async def get_requests(
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.getRequests", params)
        model = self.get_model(
    ...
    async def get_settings(self, group_id: int, **kwargs) -> GetSettingsResponseModel:
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.getSettings", params)
    ...
    async def get_tag_list(
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.getTagList", params)
    ...
    async def get_token_permissions(self, **kwargs) -> GetTokenPermissionsResponseModel:
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.getTokenPermissions", params)
    ...
    async def invite(self, group_id: int, user_id: int, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.invite", params)
        model = OkResponse
        return model(**response).response
    ...
    async def is_member(
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.isMember", params)
        model = self.get_model(
            (
    ...
    async def join(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.join", params)
        model = OkResponse
        return model(**response).response
    ...
    async def leave(self, group_id: int, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.leave", params)
        model = OkResponse
        return model(**response).response
    ...
    async def remove_user(self, group_id: int, user_id: int, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.removeUser", params)
        model = OkResponse
        return model(**response).response
    ...
    async def reorder_link(
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.reorderLink", params)
        model = OkResponse
        return model(**response).response
    ...
    async def search(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.search", params)
    ...
    async def set_callback_settings(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.setCallbackSettings", params)
        model = OkResponse
        return model(**response).response
    ...
    async def set_long_poll_settings(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.setLongPollSettings", params)
        model = OkResponse
        return model(**response).response
    ...
    async def set_settings(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.setSettings", params)
        model = OkResponse
        return model(**response).response
    ...
    async def set_user_note(
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.setUserNote", params)
        model = BoolResponse
        return model(**response).response
    ...
    async def tag_add(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.tagAdd", params)
        model = BoolResponse
        return model(**response).response
    ...
    async def tag_bind(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.tagBind", params)
        model = BoolResponse
        return model(**response).response
    ...
    async def tag_delete(self, group_id: int, tag_id: int, **kwargs) -> BaseBoolInt:
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.tagDelete", params)
        model = BoolResponse
        return model(**response).response
    ...
    async def tag_update(
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.tagUpdate", params)
        model = BoolResponse
        return model(**response).response
    ...
    async def toggle_market(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.toggleMarket", params)
        model = OkResponse
        return model(**response).response
    ...
    async def unban(
        ...
        params = self.get_set_params(locals())
        response = await self.request("groups.unban", params)
        model = OkResponse
        return model(**response).response
