...
from aiovkapi.types.responses.base import (
    BaseBoolInt,
    BaseGetUploadServerResponse,
    BaseUploadServer,
    OkResponse,
)
from aiovkapi.types.responses.photos import (
    CopyResponse,
    CreateAlbumResponse,
...
class PhotosCategory(BaseCategory):
    async def confirm_tag(
        ...
        **kwargs
        ...
        response = await self.request("photos.confirmTag", params)
        model = OkResponse
    ...
    async def copy(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.copy", params)
        model = CopyResponse
        return model(**response).response
    ...
    async def create_album(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.createAlbum", params)
    ...
    async def create_comment(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.createComment", params)
    ...
    async def delete(
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.delete", params)
        model = OkResponse
        return model(**response).response
    ...
    async def delete_album(
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.deleteAlbum", params)
        model = OkResponse
        return model(**response).response
    ...
    async def delete_comment(
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.deleteComment", params)
    ...
    async def edit(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.edit", params)
        model = OkResponse
        return model(**response).response
    ...
    async def edit_album(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.editAlbum", params)
        model = OkResponse
        return model(**response).response
    ...
    async def edit_comment(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.editComment", params)
        model = OkResponse
        return model(**response).response
    ...
    async def get(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.get", params)
        model = GetResponse
        return model(**response).response
    ...
    async def get_albums(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.getAlbums", params)
    ...
    async def get_albums_count(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.getAlbumsCount", params)
    ...
    async def get_all(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.getAll", params)
    ...
    async def get_all_comments(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.getAllComments", params)
    ...
    async def get_by_id(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.getById", params)
    ...
    async def get_chat_upload_server(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.getChatUploadServer", params)
    ...
    async def get_comments(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.getComments", params)
        model = self.get_model(
    ...
    async def get_market_album_upload_server(
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.getMarketAlbumUploadServer", params)
        model = BaseGetUploadServerResponse
        return model(**response).response
    ...
    async def get_market_upload_server(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.getMarketUploadServer", params)
    ...
    async def get_messages_upload_server(
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.getMessagesUploadServer", params)
    ...
    async def get_new_tags(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.getNewTags", params)
    ...
    async def get_owner_cover_photo_upload_server(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.getOwnerCoverPhotoUploadServer", params)
        model = BaseGetUploadServerResponse
        return model(**response).response
    ...
    async def get_owner_photo_upload_server(
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.getOwnerPhotoUploadServer", params)
        model = BaseGetUploadServerResponse
        return model(**response).response
    ...
    async def get_tags(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.getTags", params)
    ...
    async def get_upload_server(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.getUploadServer", params)
    ...
    async def get_user_photos(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.getUserPhotos", params)
    ...
    async def get_wall_upload_server(
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.getWallUploadServer", params)
    ...
    async def make_cover(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.makeCover", params)
        model = OkResponse
        return model(**response).response
    ...
    async def move(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.move", params)
        model = OkResponse
        return model(**response).response
    ...
    async def put_tag(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.putTag", params)
    ...
    async def remove_tag(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.removeTag", params)
        model = OkResponse
        return model(**response).response
    ...
    async def reorder_albums(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.reorderAlbums", params)
        model = OkResponse
        return model(**response).response
    ...
    async def reorder_photos(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.reorderPhotos", params)
        model = OkResponse
        return model(**response).response
    ...
    async def report(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.report", params)
        model = OkResponse
        return model(**response).response
    ...
    async def report_comment(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.reportComment", params)
        model = OkResponse
        return model(**response).response
    ...
    async def restore(
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.restore", params)
        model = OkResponse
        return model(**response).response
    ...
    async def restore_comment(
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.restoreComment", params)
    ...
    async def save(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.save", params)
        model = SaveResponse
        return model(**response).response
    ...
    async def save_market_album_photo(
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.saveMarketAlbumPhoto", params)
    ...
    async def save_market_photo(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.saveMarketPhoto", params)
    ...
    async def save_messages_photo(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.saveMessagesPhoto", params)
    ...
    async def save_owner_cover_photo(
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.saveOwnerCoverPhoto", params)
    ...
    async def save_owner_photo(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.saveOwnerPhoto", params)
    ...
    async def save_wall_photo(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.saveWallPhoto", params)
    ...
    async def search(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("photos.search", params)
