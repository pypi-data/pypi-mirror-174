...
from aiovkapi.types.responses.polls import (
    AddVoteResponse,
    CreateResponse,
    DeleteVoteResponse,
...
class PollsCategory(BaseCategory):
    async def add_vote(
        ...
        **kwargs
        ...
        response = await self.request("polls.addVote", params)
    ...
    async def create(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("polls.create", params)
    ...
    async def delete_vote(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("polls.deleteVote", params)
    ...
    async def edit(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("polls.edit", params)
        model = OkResponse
        return model(**response).response
    ...
    async def get_backgrounds(self, **kwargs) -> typing.List[PollsBackground]:
        ...
        params = self.get_set_params(locals())
        response = await self.request("polls.getBackgrounds", params)
    ...
    async def get_by_id(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("polls.getById", params)
    ...
    async def get_photo_upload_server(
        ...
        params = self.get_set_params(locals())
        response = await self.request("polls.getPhotoUploadServer", params)
    ...
    async def get_voters(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("polls.getVoters", params)
    ...
    async def save_photo(self, photo: str, hash: str, **kwargs) -> PollsBackground:
        ...
        params = self.get_set_params(locals())
        response = await self.request("polls.savePhoto", params)
