...
from aiovkapi.types.responses.notes import (
    AddResponse,
...
class NotesCategory(BaseCategory):
    async def add(
        ...
        **kwargs
        ...
        response = await self.request("notes.add", params)
        model = AddResponse
    ...
    async def create_comment(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("notes.createComment", params)
    ...
    async def delete(self, note_id: int, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("notes.delete", params)
        model = OkResponse
        return model(**response).response
    ...
    async def delete_comment(
        ...
        params = self.get_set_params(locals())
        response = await self.request("notes.deleteComment", params)
        model = OkResponse
        return model(**response).response
    ...
    async def edit(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("notes.edit", params)
        model = OkResponse
        return model(**response).response
    ...
    async def edit_comment(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("notes.editComment", params)
        model = OkResponse
        return model(**response).response
    ...
    async def get(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("notes.get", params)
        model = GetResponse
        return model(**response).response
    ...
    async def get_by_id(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("notes.getById", params)
    ...
    async def get_comments(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("notes.getComments", params)
    ...
    async def restore_comment(
        ...
        params = self.get_set_params(locals())
        response = await self.request("notes.restoreComment", params)
        model = OkResponse
        return model(**response).response
