...
from aiovkapi.types.responses.newsfeed import (
    GenericResponse,
...
class NewsfeedCategory(BaseCategory):
    async def add_ban(
        ...
        **kwargs
        ...
        response = await self.request("newsfeed.addBan", params)
        model = OkResponse
    ...
    async def delete_ban(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("newsfeed.deleteBan", params)
        model = OkResponse
        return model(**response).response
    ...
    async def delete_list(self, list_id: int, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("newsfeed.deleteList", params)
        model = OkResponse
        return model(**response).response
    ...
    async def get(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("newsfeed.get", params)
    ...
    async def get_banned(
        ...
        params = self.get_set_params(locals())
        response = await self.request("newsfeed.getBanned", params)
    ...
    async def get_comments(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("newsfeed.getComments", params)
    ...
    async def get_lists(
        ...
        params = self.get_set_params(locals())
        response = await self.request("newsfeed.getLists", params)
        model = self.get_model(
    ...
    async def get_mentions(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("newsfeed.getMentions", params)
    ...
    async def get_recommended(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("newsfeed.getRecommended", params)
        model = GenericResponse
        return model(**response).response
    ...
    async def get_suggested_sources(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("newsfeed.getSuggestedSources", params)
    ...
    async def ignore_item(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("newsfeed.ignoreItem", params)
        model = OkResponse
        return model(**response).response
    ...
    async def save_list(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("newsfeed.saveList", params)
    ...
    async def search(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("newsfeed.search", params)
        model = self.get_model(
    ...
    async def unignore_item(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("newsfeed.unignoreItem", params)
        model = OkResponse
        return model(**response).response
    ...
    async def unsubscribe(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("newsfeed.unsubscribe", params)
        model = OkResponse
        return model(**response).response
