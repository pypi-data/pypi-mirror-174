...
from aiovkapi.types.responses.friends import (
    AddListResponse,
...
class FriendsCategory(BaseCategory):
    async def add(
        ...
        **kwargs
        ...
        response = await self.request("friends.add", params)
        model = AddResponse
    ...
    async def add_list(
        ...
        params = self.get_set_params(locals())
        response = await self.request("friends.addList", params)
    ...
    async def are_friends(
        ...
        params = self.get_set_params(locals())
        response = await self.request("friends.areFriends", params)
    ...
    async def delete(
        ...
        params = self.get_set_params(locals())
        response = await self.request("friends.delete", params)
    ...
    async def delete_all_requests(self, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("friends.deleteAllRequests", params)
        model = OkResponse
        return model(**response).response
    ...
    async def delete_list(self, list_id: int, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("friends.deleteList", params)
        model = OkResponse
        return model(**response).response
    ...
    async def edit(
        ...
        params = self.get_set_params(locals())
        response = await self.request("friends.edit", params)
        model = OkResponse
        return model(**response).response
    ...
    async def edit_list(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("friends.editList", params)
        model = OkResponse
        return model(**response).response
    ...
    async def get(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("friends.get", params)
        model = self.get_model(
    ...
    async def get_app_users(self, **kwargs) -> typing.List[int]:
        ...
        params = self.get_set_params(locals())
        response = await self.request("friends.getAppUsers", params)
    ...
    async def get_by_phones(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("friends.getByPhones", params)
    ...
    async def get_lists(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("friends.getLists", params)
    ...
    async def get_mutual(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("friends.getMutual", params)
        model = self.get_model(
    ...
    async def get_online(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("friends.getOnline", params)
        model = self.get_model(
    ...
    async def get_recent(
        ...
        params = self.get_set_params(locals())
        response = await self.request("friends.getRecent", params)
    ...
    async def get_requests(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("friends.getRequests", params)
        model = self.get_model(
            (
    ...
    async def get_suggestions(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("friends.getSuggestions", params)
    ...
    async def search(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("friends.search", params)
