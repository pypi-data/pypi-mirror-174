...
from aiovkapi.types.responses.lead_forms import (
    CreateResponse,
    CreateResponseModel,
    DeleteResponse,
    DeleteResponseModel,
...
class LeadFormsCategory(BaseCategory):
    async def create(
        ...
        **kwargs
        ...
        response = await self.request("leadForms.create", params)
    ...
    async def delete(
        ...
        params = self.get_set_params(locals())
        response = await self.request("leadForms.delete", params)
    ...
    async def get(self, group_id: int, form_id: int, **kwargs) -> LeadFormsForm:
        ...
        params = self.get_set_params(locals())
        response = await self.request("leadForms.get", params)
        model = GetResponse
        return model(**response).response
    ...
    async def get_leads(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("leadForms.getLeads", params)
    ...
    async def get_upload_url(self, **kwargs) -> str:
        ...
        params = self.get_set_params(locals())
        response = await self.request("leadForms.getUploadURL", params)
    ...
    async def list(self, group_id: int, **kwargs) -> typing.List[LeadFormsForm]:
        ...
        params = self.get_set_params(locals())
        response = await self.request("leadForms.list", params)
        model = ListResponse
        return model(**response).response
    ...
    async def update(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("leadForms.update", params)
        model = CreateResponse
        return model(**response).response
