...
from aiovkapi.types.responses.likes import (
    AddResponse,
    AddResponseModel,
    DeleteResponse,
    DeleteResponseModel,
...
class LikesCategory(BaseCategory):
    async def add(
        ...
        **kwargs
        ...
        response = await self.request("likes.add", params)
        model = AddResponse
    ...
    async def delete(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("likes.delete", params)
    ...
    async def get_list(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("likes.getList", params)
    ...
    async def is_liked(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("likes.isLiked", params)
