...
from aiovkapi.types.responses.secure import (
    CheckTokenResponse,
...
class SecureCategory(BaseCategory):
    async def add_app_event(
        ...
        **kwargs
        ...
        response = await self.request("secure.addAppEvent", params)
        model = OkResponse
    ...
    async def check_token(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("secure.checkToken", params)
    ...
    async def get_app_balance(self, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("secure.getAppBalance", params)
    ...
    async def get_sms_history(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("secure.getSMSHistory", params)
    ...
    async def get_transactions_history(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("secure.getTransactionsHistory", params)
    ...
    async def get_user_level(
        ...
        params = self.get_set_params(locals())
        response = await self.request("secure.getUserLevel", params)
    ...
    async def give_event_sticker(
        ...
        params = self.get_set_params(locals())
        response = await self.request("secure.giveEventSticker", params)
    ...
    async def send_notification(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("secure.sendNotification", params)
    ...
    async def send_sms_notification(self, user_id: int, message: str, **kwargs) -> int:
        ...
        params = self.get_set_params(locals())
        response = await self.request("secure.sendSMSNotification", params)
        model = OkResponse
        return model(**response).response
    ...
    async def set_counter(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("secure.setCounter", params)
