...
from aiovkapi.types.responses.database import (
    BaseCountry,
    DatabaseCityById,
    DatabaseStation,
    GetChairsResponse,
...
class DatabaseCategory(BaseCategory):
    async def get_chairs(
        ...
        **kwargs
        ...
        response = await self.request("database.getChairs", params)
    ...
    async def get_cities(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("database.getCities", params)
    ...
    async def get_cities_by_id(
        ...
        params = self.get_set_params(locals())
        response = await self.request("database.getCitiesById", params)
    ...
    async def get_countries(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("database.getCountries", params)
    ...
    async def get_countries_by_id(
        ...
        params = self.get_set_params(locals())
        response = await self.request("database.getCountriesById", params)
    ...
    async def get_faculties(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("database.getFaculties", params)
    ...
    async def get_metro_stations(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("database.getMetroStations", params)
    ...
    async def get_metro_stations_by_id(
        ...
        params = self.get_set_params(locals())
        response = await self.request("database.getMetroStationsById", params)
    ...
    async def get_regions(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("database.getRegions", params)
    ...
    async def get_school_classes(
        ...
        params = self.get_set_params(locals())
        response = await self.request("database.getSchoolClasses", params)
    ...
    async def get_schools(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("database.getSchools", params)
    ...
    async def get_universities(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("database.getUniversities", params)
