...
from aiovkapi.types.responses.storage import GetKeysResponse, GetResponse, StorageValue
...
class StorageCategory(BaseCategory):
    async def get(
        ...
        **kwargs
        ...
        response = await self.request("storage.get", params)
        model = GetResponse
    ...
    async def get_keys(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("storage.getKeys", params)
    ...
    async def set(
        ...
        **kwargs
        ...
        params = self.get_set_params(locals())
        response = await self.request("storage.set", params)
        model = OkResponse
        return model(**response).response
