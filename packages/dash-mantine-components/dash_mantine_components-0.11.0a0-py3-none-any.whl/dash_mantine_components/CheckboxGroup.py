...
- withAsterisk (boolean; optional):
    ...
    _type = 'CheckboxGroup'
    @_explicitize_args
    def __init__(self, children=None, value=Component.UNDEFINED, orientation=Component.UNDEFINED, spacing=Component.UNDEFINED, offset=Component.UNDEFINED, size=Component.UNDEFINED, label=Component.UNDEFINED, description=Component.UNDEFINED, error=Component.UNDEFINED, required=Component.UNDEFINED, withAsterisk=Component.UNDEFINED, inputWrapperOrder=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, styles=Component.UNDEFINED, id=Component.UNDEFINED, unstyled=Component.UNDEFINED, sx=Component.UNDEFINED, m=Component.UNDEFINED, my=Component.UNDEFINED, mx=Component.UNDEFINED, mt=Component.UNDEFINED, mb=Component.UNDEFINED, ml=Component.UNDEFINED, mr=Component.UNDEFINED, p=Component.UNDEFINED, py=Component.UNDEFINED, px=Component.UNDEFINED, pt=Component.UNDEFINED, pb=Component.UNDEFINED, pl=Component.UNDEFINED, pr=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'className', 'description', 'error', 'inputWrapperOrder', 'label', 'm', 'mb', 'ml', 'mr', 'mt', 'mx', 'my', 'offset', 'orientation', 'p', 'pb', 'pl', 'pr', 'pt', 'px', 'py', 'required', 'size', 'spacing', 'style', 'styles', 'sx', 'unstyled', 'value', 'withAsterisk']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'description', 'error', 'inputWrapperOrder', 'label', 'm', 'mb', 'ml', 'mr', 'mt', 'mx', 'my', 'offset', 'orientation', 'p', 'pb', 'pl', 'pr', 'pt', 'px', 'py', 'required', 'size', 'spacing', 'style', 'styles', 'sx', 'unstyled', 'value', 'withAsterisk']
