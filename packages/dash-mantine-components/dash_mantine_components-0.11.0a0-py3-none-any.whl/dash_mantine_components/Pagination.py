...
- withEdges (boolean; optional):
    ...
    _type = 'Pagination'
    @_explicitize_args
    def __init__(self, color=Component.UNDEFINED, page=Component.UNDEFINED, total=Component.REQUIRED, siblings=Component.UNDEFINED, boundaries=Component.UNDEFINED, spacing=Component.UNDEFINED, size=Component.UNDEFINED, radius=Component.UNDEFINED, withEdges=Component.UNDEFINED, withControls=Component.UNDEFINED, disabled=Component.UNDEFINED, position=Component.UNDEFINED, noWrap=Component.UNDEFINED, grow=Component.UNDEFINED, align=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, styles=Component.UNDEFINED, id=Component.UNDEFINED, unstyled=Component.UNDEFINED, sx=Component.UNDEFINED, m=Component.UNDEFINED, my=Component.UNDEFINED, mx=Component.UNDEFINED, mt=Component.UNDEFINED, mb=Component.UNDEFINED, ml=Component.UNDEFINED, mr=Component.UNDEFINED, p=Component.UNDEFINED, py=Component.UNDEFINED, px=Component.UNDEFINED, pt=Component.UNDEFINED, pb=Component.UNDEFINED, pl=Component.UNDEFINED, pr=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'align', 'boundaries', 'className', 'color', 'disabled', 'grow', 'm', 'mb', 'ml', 'mr', 'mt', 'mx', 'my', 'noWrap', 'p', 'page', 'pb', 'pl', 'position', 'pr', 'pt', 'px', 'py', 'radius', 'siblings', 'size', 'spacing', 'style', 'styles', 'sx', 'total', 'unstyled', 'withControls', 'withEdges']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'align', 'boundaries', 'className', 'color', 'disabled', 'grow', 'm', 'mb', 'ml', 'mr', 'mt', 'mx', 'my', 'noWrap', 'p', 'page', 'pb', 'pl', 'position', 'pr', 'pt', 'px', 'py', 'radius', 'siblings', 'size', 'spacing', 'style', 'styles', 'sx', 'total', 'unstyled', 'withControls', 'withEdges']
