...
setup(
    ...
    data_files=[
        ('russian_uncensor/data', ['russian_uncensor/data/obscene_words.marisa']),
        ('russian_uncensor/data/ngrams', [
            'russian_uncensor/data/ngrams/freq_letters.marisa',
            'russian_uncensor/data/ngrams/bi_grams.marisa',
            'russian_uncensor/data/ngrams/tri_grams.marisa',
        ]),
    ],
)
