...
# -*- coding: utf-8 -*-
#
# ndx-extract documentation build configuration file, created by
# sphinx-quickstart on Fri Nov 12 17:31:48 2021.
#
...
project = 'ndx-extract'
copyright = '2021, Cesar Echavarria'
...
htmlhelp_basename = 'ndx-extractdoc'
...
latex_documents = [
    (master_doc, 'ndx-extract.tex', 'ndx-extract Documentation',
     'Cesar Echavarria', 'manual'),
]
...
man_pages = [
    (master_doc, 'ndx-extract', 'ndx-extract Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ndx-extract', 'ndx-extract Documentation',
     author, 'ndx-extract', 'One line description of project.',
     'Miscellaneous'),
]
