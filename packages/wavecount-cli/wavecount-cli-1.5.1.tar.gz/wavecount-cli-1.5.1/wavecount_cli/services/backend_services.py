...
class Backend:
    ...
    def _call_api(self, path, method='get', params={}, data={}, running_message='wait a moment ...', done_message=''):
    ...
    def reset_hash_time(self, datetime: str, where):
        ...
        result = self._call_api(method='post', path=path, params=params, data={'datetime': datetime}, running_message='Running ...')
        return result.json()
