...
class _IDatabaseClusterProxy(
    ...
    def metric(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IDatabaseCluster.metric)
...
class _IDatabaseInstanceProxy(
    ...
    def metric(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IDatabaseInstance.metric)
            check_type(argname="argument metric_name", value=metric_name, expected_type=type_hints["metric_name"])
        props = aws_cdk.aws_cloudwatch.MetricOptions(
            account=account,
            color=color,
...
class LogType(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-neptune-alpha.LogType"):
    ...
    def __init__(self, value: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LogType.__init__)
...
class DatabaseClusterBase(
    ...
    def metric(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DatabaseClusterBase.metric)
            check_type(argname="argument metric_name", value=metric_name, expected_type=type_hints["metric_name"])
        props = aws_cdk.aws_cloudwatch.MetricOptions(
            account=account,
            color=color,
...
class DatabaseInstanceBase(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DatabaseInstanceBase.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = aws_cdk.ResourceProps(
            account=account,
    ...
    def from_database_instance_attributes(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DatabaseInstanceBase.from_database_instance_attributes)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def metric(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DatabaseInstanceBase.metric)
            check_type(argname="argument metric_name", value=metric_name, expected_type=type_hints["metric_name"])
        props = aws_cdk.aws_cloudwatch.MetricOptions(
            account=account,
            color=color,
