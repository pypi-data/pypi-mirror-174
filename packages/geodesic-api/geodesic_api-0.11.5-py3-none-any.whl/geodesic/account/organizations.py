...
from geodesic.descriptors import IntDescr, StringDescr
...
class Organization(APIObject):
    ...
    name = StringDescr(doc="name of this organization")
    alias = StringDescr(doc="alias for this organization")
    description = StringDescr(doc="description of this organization")
    homepage = StringDescr(doc="homepage for this organization")
    total_seats = IntDescr(doc="total number of user seats for this organization")
    ...
    def add_members(self, members: List[User] = [], admins: List[User] = []) -> None:
        ...
        raise_on_error(self._client.post(f"{self.name}/members", members=member_subjects, admins=admin_subjects))
