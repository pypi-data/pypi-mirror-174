...
package_data = \
{'': ['*'],
 'sneks.tests': ['env-for-parsing-pdm/*',
                 'env-for-parsing-poetry-path-dep/*',
                 'env-for-parsing-poetry/*',
                 'env-for-running-pdm/pdm.lock',
                 'env-for-running-pdm/pdm.lock',
                 'env-for-running-pdm/pyproject.toml',
                 'env-for-running-pdm/pyproject.toml',
                 'env-for-running-poetry/*']}
