...
def cli_verify_destination_md5_hash_task(task):
    """
    TBD
    """
    ...
    # If no if statement match the whole for loop
...
def cli_verify_destination_md5_hash(nr_obj):
    ...
    task_result = nr_obj.run(task=cli_verify_destination_md5_hash_task, name="CLI verify destination file")
    ...
    # failed_hosts = [host for host in task_result.failed_hosts]
