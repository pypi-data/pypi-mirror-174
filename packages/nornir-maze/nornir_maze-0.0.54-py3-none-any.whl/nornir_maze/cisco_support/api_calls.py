...
def cisco_support_check_authentication(
    api_client_creds: tuple, verbose: bool = False, silent: bool = False
) -> bool:
    """
...
def get_sni_owner_coverage_by_serial_number(serial_dict: dict, api_client_creds: tuple) -> dict:
    """
...
def get_sni_coverage_summary_by_serial_numbers(serial_dict: dict, api_client_creds: tuple) -> dict:
    """
    This function takes the serial_dict which contains all serial numbers and the Cisco support API creds to
...
def get_eox_by_serial_numbers(serial_dict: dict, api_client_creds: tuple) -> dict:
    """
    This function takes the serial_dict which contains all serial numbers and the Cisco support API creds to
