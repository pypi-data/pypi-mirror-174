...
class Add(Circuit):
    def __init__(self, nodes: Sequence[Circuit], name: Optional[str] = None) -> None: ...
    @property
...
class Concat(Circuit):
    def __init__(self, nodes: Sequence[Circuit], axis: int, name: Optional[str] = None) -> None: ...
    @property
    def nodes(self) -> List[Circuit]: ...
    @property
    def axis(self) -> int: ...
    ...
    @staticmethod
    def stack(nodes: Sequence[Circuit], axis: int, name: Optional[str] = None) -> Concat: ...
...
class Cumulant(Circuit):
    ...
    @staticmethod
    def new_canon_rearrange(nodes: Sequence[Circuit], name: Optional[str] = None) -> Cumulant: ...
