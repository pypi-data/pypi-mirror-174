...
use super::{
    ...
    deep_map_preorder_unwrap, deep_map_unwrap,
...
use crate::{
    circuit::{
        batching::batch_einsum, deep_map_op_context, generalfunction_merge_inverses,
        generalfunction_rewrite::generalfunction_evaluate_simple,
        generalfunction_special_case_simplification, module_rewrite::elim_empty_module,
        scatter_rewrite::concat_to_scatter,
    },
    pyo3_prelude::*,
    timed, timed_value,
