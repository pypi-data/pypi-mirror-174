...
# import weakref
# tensor_hash_cache:weakref.WeakKeyDictionary = weakref.WeakKeyDictionary()

# # we had issues with caching by id(tensor), using weakref instead
# def hash_tensor(tensor):
#     cached = tensor_hash_cache.get(tensor)
#     if cached is not None:
#         return cached
#     hash_out = hash_tensor_impl(tensor)
#     tensor_hash_cache[tensor] = hash_out
#     return hash_out
