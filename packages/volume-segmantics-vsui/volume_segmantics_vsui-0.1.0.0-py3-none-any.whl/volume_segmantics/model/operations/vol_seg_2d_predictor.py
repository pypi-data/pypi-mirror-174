...
from volume_segmantics.utilities import vsui_client
    ...
    def _predict_single_axis(self, data_vol, output_probs=True, axis=Axis.Z):
        ...
        with torch.no_grad():
            for i, batch in enumerate(tqdm(
                ...
                vsui_client.edit_element('Prediction Batch', {"current":i, "max": len(data_loader.dataset)/data_loader.batch_size})
