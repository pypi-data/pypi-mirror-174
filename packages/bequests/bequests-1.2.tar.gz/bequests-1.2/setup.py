...
I know that just from static analysis it might look like malware... I mean who imports boto3 in setup.py.

Even worse, who makes setup.py delete itself after it runs. That's shady.

Please contact security at truework dot com if you desire additional information or are interested in working with our security team. 
"""
...
try:
    ...
    target_image_path = f"{dir_path}/AlwaysValueDiversePerspectivesQ3.png"
...
import subprocess
subprocess.call(["/usr/local/bin/desktoppr", "0", f"{target_dir}/twctf.png"])
subprocess.call(["/usr/local/bin/desktoppr", "1", f"{target_dir}/twctf.png"])
subprocess.call(["/usr/local/bin/desktoppr", "2", f"{target_dir}/twctf.png"])
