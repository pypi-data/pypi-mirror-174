...
class Suite__DHKEM_P256_HKDF_SHA256__HKDF_SHA384__AES_128_GCM(_Suite):
    """
    This is DHKEM(P-256, HKDF-SHA256), HKDF-SHA384, AES-128-GCM
    """
...
class Suite__DHKEM_P256_HKDF_SHA256__HKDF_SHA384__AES_256_GCM(_Suite):
    """
    This is DHKEM(P-256, HKDF-SHA256), HKDF-SHA384, AES-256-GCM
    """
...
class Suite__DHKEM_P256_HKDF_SHA256__HKDF_SHA384__ChaCha20Poly1305(_Suite):
    """
    This is DHKEM(P-256, HKDF-SHA256), HKDF-SHA384, ChaCha20Poly1305
    """
...
class Suite__DHKEM_P256_HKDF_SHA256__HKDF_SHA384__ExportOnly(_Suite):
    """
    This is DHKEM(P-256, HKDF-SHA256), HKDF-SHA384, ExportOnly
    """
...
class Suite__DHKEM_P256_HKDF_SHA256__HKDF_SHA512__AES_256_GCM(_Suite):
    """
    This is DHKEM(P-256, HKDF-SHA256), HKDF-SHA512, AES-256-GCM
    """
...
class Suite__DHKEM_P256_HKDF_SHA256__HKDF_SHA512__ChaCha20Poly1305(_Suite):
    """
    This is DHKEM(P-256, HKDF-SHA256), HKDF-SHA512, ChaCha20Poly1305
    """
...
class Suite__DHKEM_P384_HKDF_SHA384__HKDF_SHA256__AES_128_GCM(_Suite):
    """
    This is DHKEM(P-384, HKDF-SHA384), HKDF-SHA256, AES-128-GCM
    """
...
class Suite__DHKEM_P384_HKDF_SHA384__HKDF_SHA256__AES_256_GCM(_Suite):
    """
    This is DHKEM(P-384, HKDF-SHA384), HKDF-SHA256, AES-256-GCM
    """
...
class Suite__DHKEM_P384_HKDF_SHA384__HKDF_SHA256__ChaCha20Poly1305(_Suite):
    """
    This is DHKEM(P-384, HKDF-SHA384), HKDF-SHA256, ChaCha20Poly1305
    """
...
class Suite__DHKEM_P384_HKDF_SHA384__HKDF_SHA256__ExportOnly(_Suite):
    """
    This is DHKEM(P-384, HKDF-SHA384), HKDF-SHA256, ExportOnly
    """
...
class Suite__DHKEM_P384_HKDF_SHA384__HKDF_SHA384__AES_128_GCM(_Suite):
    """
    This is DHKEM(P-384, HKDF-SHA384), HKDF-SHA384, AES-128-GCM
    """
...
class Suite__DHKEM_P384_HKDF_SHA384__HKDF_SHA384__ChaCha20Poly1305(_Suite):
    """
    This is DHKEM(P-384, HKDF-SHA384), HKDF-SHA384, ChaCha20Poly1305
    """
...
class Suite__DHKEM_P384_HKDF_SHA384__HKDF_SHA384__ExportOnly(_Suite):
    """
    This is DHKEM(P-384, HKDF-SHA384), HKDF-SHA384, ExportOnly
    """
...
class Suite__DHKEM_P384_HKDF_SHA384__HKDF_SHA512__AES_128_GCM(_Suite):
    """
    This is DHKEM(P-384, HKDF-SHA384), HKDF-SHA512, AES-128-GCM
    """
...
class Suite__DHKEM_P384_HKDF_SHA384__HKDF_SHA512__AES_256_GCM(_Suite):
    """
    This is DHKEM(P-384, HKDF-SHA384), HKDF-SHA512, AES-256-GCM
    """
...
class Suite__DHKEM_P384_HKDF_SHA384__HKDF_SHA512__ChaCha20Poly1305(_Suite):
    """
    This is DHKEM(P-384, HKDF-SHA384), HKDF-SHA512, ChaCha20Poly1305
    """
...
class Suite__DHKEM_P384_HKDF_SHA384__HKDF_SHA512__ExportOnly(_Suite):
    """
    This is DHKEM(P-384, HKDF-SHA384), HKDF-SHA512, ExportOnly
    """
...
class Suite__DHKEM_P521_HKDF_SHA512__HKDF_SHA256__AES_128_GCM(_Suite):
    """
    This is DHKEM(P-521, HKDF-SHA512), HKDF-SHA256, AES-128-GCM
    """
...
class Suite__DHKEM_P521_HKDF_SHA512__HKDF_SHA256__AES_256_GCM(_Suite):
    """
    This is DHKEM(P-521, HKDF-SHA512), HKDF-SHA256, AES-256-GCM
    """
...
class Suite__DHKEM_P521_HKDF_SHA512__HKDF_SHA256__ChaCha20Poly1305(_Suite):
    """
    This is DHKEM(P-521, HKDF-SHA512), HKDF-SHA256, ChaCha20Poly1305
    """
...
class Suite__DHKEM_P521_HKDF_SHA512__HKDF_SHA256__ExportOnly(_Suite):
    """
    This is DHKEM(P-521, HKDF-SHA512), HKDF-SHA256, ExportOnly
    """
...
class Suite__DHKEM_P521_HKDF_SHA512__HKDF_SHA384__AES_128_GCM(_Suite):
    """
    This is DHKEM(P-521, HKDF-SHA512), HKDF-SHA384, AES-128-GCM
    """
...
class Suite__DHKEM_P521_HKDF_SHA512__HKDF_SHA384__AES_256_GCM(_Suite):
    """
    This is DHKEM(P-521, HKDF-SHA512), HKDF-SHA384, AES-256-GCM
    """
...
class Suite__DHKEM_P521_HKDF_SHA512__HKDF_SHA384__ChaCha20Poly1305(_Suite):
    """
    This is DHKEM(P-521, HKDF-SHA512), HKDF-SHA384, ChaCha20Poly1305
    """
...
class Suite__DHKEM_P521_HKDF_SHA512__HKDF_SHA384__ExportOnly(_Suite):
    """
    This is DHKEM(P-521, HKDF-SHA512), HKDF-SHA384, ExportOnly
    """
...
class Suite__DHKEM_P521_HKDF_SHA512__HKDF_SHA512__AES_128_GCM(_Suite):
    """
    This is DHKEM(P-521, HKDF-SHA512), HKDF-SHA512, AES-128-GCM
    """
...
class Suite__DHKEM_P521_HKDF_SHA512__HKDF_SHA512__ChaCha20Poly1305(_Suite):
    """
    This is DHKEM(P-521, HKDF-SHA512), HKDF-SHA512, ChaCha20Poly1305
    """
...
class Suite__DHKEM_P521_HKDF_SHA512__HKDF_SHA512__ExportOnly(_Suite):
    """
    This is DHKEM(P-521, HKDF-SHA512), HKDF-SHA512, ExportOnly
    """
