...
def get_exclusion_interval_query(exclusion_api_ip: str, exclusion_interval: ExclusionInterval) -> List[Dict]:
    query = make_exclusion_interval_query(exclusion_api_ip=exclusion_api_ip,
                                          exclusion_interval=exclusion_interval)
...
def delete_exclusion_interval_query(exclusion_api_ip: str, exclusion_interval: ExclusionInterval) -> None:
    query = make_exclusion_interval_query(exclusion_api_ip=exclusion_api_ip,
                                          exclusion_interval=exclusion_interval)
