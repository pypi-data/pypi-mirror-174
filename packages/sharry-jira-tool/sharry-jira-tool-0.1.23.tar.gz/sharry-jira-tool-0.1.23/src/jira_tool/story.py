...
def sort_stories_by_order(stories: "list[Story]", excel_defination: ExcelDefination):
    sort_rules = []
    excel_defination_columns = excel_defination.get_columns()

    for _, column_name, _, require_sort, sort_order, _, _ in excel_defination_columns:
        if require_sort is True:
            sort_rules.append((column_name, sort_order))

    _internal_sort_stories_by_order(stories, sort_rules)


def _internal_sort_stories_by_order(stories: "list[Story]", sort_rules: "list[tuple]"):
