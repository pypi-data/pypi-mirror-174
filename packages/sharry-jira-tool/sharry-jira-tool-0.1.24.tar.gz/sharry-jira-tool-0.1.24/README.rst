...
If you want to customize the defination file to adapt the new Excel, you can do below steps.

1. Creating the defination file like below. Inside the :code:`SortStrategyPriority` list, you can decide the sort algorithms' order.
...
2. Indicating the defination file location to the :code:`process_excel_file` method like below.
...
.. code-block:: python
  ...
  process_excel_file(
      HERE / "source.xlsx", 
      HERE / "target.xlsx", 
      excel_defination_config=HERE / "defination_file.json"
  )
