...
class HttpConfig(BaseModel):
    ...
    @root_validator
    @classmethod
    def default_client_version(cls, values: dict) -> dict:
        """Default the client version to the package version."""
        if values["client_name"] == "fw-http-client":
            version = import_module("fw_http_client").__version__
