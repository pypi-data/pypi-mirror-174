...
# -----------------------------------------------------------------------------
test_result_file_name = str(Path() / ".." / "requests_" / "test_reg_result")
arg_sep = "_argSEP_"
p = Path()
# pickle_folder = p.absolute() / 'test_pickles'
pickle_folder = p / 'test_pickles'

create_directory(pickle_folder)
...
def get_default_cache():
    ...
    return CacheDecider.day  # obj.get(options_.default_cache, CacheDecider.day)
...
def save_pickle(file_name, data):
    ...
    # file_name_path = pickle_folder / file_name + ".pickle"
