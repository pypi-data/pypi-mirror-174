    ...
    def get_next_layer_sites(self, site_type: Union[None, str] = "fcc", ignore_index=None,
        ...
        if reformed_array:
            ...
            layer_label = self.split_layer(ignore_index=ignore_index, reverse=reverse, tol=tol, n_cluster=None,
                                           axis=2, method=None, force_plane=False, force_finite=True)
    ...
    def add_absorb(self, center=-1, site_type: Union[None, str] = "top",
        ...
        if absorb_site is None:
            ...
            if site_type == "center":
                ...
                absorb_site = self.cart_coords[center] + np.array([0, 0, offset_z]) +rdm.random(size=3)*50*random_factor
                ...
                absorb_site = st2.cart_coords[index] + np.array([0, 0, offset_z]) + rdm.random(size=3)*50*random_factor
