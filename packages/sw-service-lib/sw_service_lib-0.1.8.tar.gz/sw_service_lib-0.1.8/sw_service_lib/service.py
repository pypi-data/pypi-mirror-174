...
def get_job_by_service_identifier(
    ctx: RequestContext, service_identifier: str
) -> Optional[Job]:
    ...
    -------
    Optional[Job]
        A Job object identified by the service identifier or None.
    """
    return job.get_by_service_identifier(
        api=ctx.api or _api,
