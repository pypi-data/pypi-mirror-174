...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, defaultFilename=None, defaultPrefdefClassFile=None, defaultSaveDir=None):
        ...
        close = action('&关闭文件', self.closeFile, 'Ctrl+W', 'close.svg', u'Close current file')

        resetAll = action('&重置软件', self.resetAll, None, 'reset.svg', u'Reset all')
        ...
        copy = action('&复制矩形框', self.copySelectedShape,
                      'Ctrl+D', 'copy.svg', u'复制矩形框',
                      enabled=False)
