...
setup(
  name = 'simple_descriptive_analysis',
  packages = ['simple_descriptive_analysis'],   
  version = '0.1',      
  license='MIT',        
  ...
  url = 'https://github.com/nagorebermeosolo/simple_descriptive_analysis',   
  download_url = 'https://github.com/nagorebermeosolo/simple_descriptive_analysis/archive/refs/tags/0.1.tar.gz',   
