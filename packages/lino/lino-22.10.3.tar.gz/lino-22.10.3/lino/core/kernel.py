...
class Kernel(object):
    ...
    @property
    def lino_version(self):  # not used and not tested
        """
    ...
    def make_cache_file(self, fn, write, force=False):
        ...
        #     return 0
        fn = join(self.site.site_cache_root, fn)
    ...
    def mark_virgin(self):
        ...
        fn = self.site.cache_dir / "dbhash.json"
    ...
    def check_virgin(self):
        ...
        if not fn.exists():
            raise Exception("No `dbhash.json` in {} "
                "(did you run `django-admin prep`?)".format(self.site.cache_dir))
