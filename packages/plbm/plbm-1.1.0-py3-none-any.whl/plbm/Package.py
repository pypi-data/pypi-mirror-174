...
@Desc    :   Linux包管理工具
"""
from plbm.AptManage import AptManagement
from plbm.dpkg import DpkgManagement
from plbm.yum import YumManager
from plbm.cmd import ComMand
from plbm.Jurisdiction import Jurisdiction
from os import path, system
from plbm.logger import LInfo
...
class PackageManagement:
	def __init__(self, password, logs=True, file=None, package=None):
		...
		self.logger = LInfo(file=file, txt=logs, class_name=self.__class__.__name__)
		self.init()
