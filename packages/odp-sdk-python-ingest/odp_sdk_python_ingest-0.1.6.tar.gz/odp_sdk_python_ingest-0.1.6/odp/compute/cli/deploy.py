...
DEFAULT_VALUES = {
    ...
    "storage.python_dependencies": lambda flow, context: [
        ...
        context["pyproject"].get("azure_keyvault_secrets", "azure-keyvault-secrets~=4.6.0"),
...
def deploy_pipeline(
    ...
    registered_deployment = client.register(
        ...
        entrypoint="/opt/prefect/flows/{}:{}".format(os.path.basename(context["flow_file"]), "main"),  # type: ignore
        storage=storage,
        schedule=schedule,
        build=True,
        dry_run=dry_run,
