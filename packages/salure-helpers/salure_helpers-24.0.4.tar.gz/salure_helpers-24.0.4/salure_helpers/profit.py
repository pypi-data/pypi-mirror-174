...
class GetConnectorAsync:
    def __init__(self, salureconnect_connection: SalureConnect, token_reference: str = None, debug: bool = False):
        self.profit = GetConnector(salureconnect_connection, token_reference=token_reference)
        self.profit_async = ProfitExtractAsync(salureconnect_connection, token_reference=token_reference, debug=debug)
...
class GetConnector:
    def __init__(self, salureconnect_connection: SalureConnect, token_reference: str, debug: bool = False):
