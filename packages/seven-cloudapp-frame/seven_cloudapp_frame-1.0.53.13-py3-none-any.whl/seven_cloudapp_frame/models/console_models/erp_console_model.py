                                ...
                                for prize_order_dict in prize_order_list_dict:
                                    ...
                                    if request_params["goods"]:
                                        ...
                                        if result and result.ok:
                                            prize_order_model.update_table("sync_status=1,sync_date=%s,s5=%s", "id=%s", params=[TimeHelper.get_now_format_time(), SevenHelper.json_dumps(request_params), prize_order_dict["id"]])
                                        else:
