...
class idatetime:
    ...
    def parse_tzinfo(self, r):
        ...
        if r[3]:
            ...
            # Analisa tzname
            tzinfo = self.tzinfo_from_tzname(r[0], r[1])
    ...
    def tzinfo_from_tzname(self, benua, kota):
        return zoneinfo.ZoneInfo(f"{benua}/{kota}")
    ...
    def parse_date(self, r):
        ...
        day = r[2]
        return (
            self.parse_year([year]) | self.parse_month([month]) | self.parse_day([day])
        )
