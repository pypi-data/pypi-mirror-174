...
class AlphaInformationChunk(object):
    ...
    def binary(self):
        return msgpack.packb({
            ...
            "weighted": self.weighted, "squared": self.squared,
        })
...
class RipsInformationChunk(object):
    ...
    def binary(self):
        return msgpack.packb({
            "chunktype": "rips_information",
            "num_vertices": self.num_vertices
        })

    def metadata(self, start):
        return {
            "chunktype": "rips_information", "start": start, "length": len(self.binary)
        }
...
class GraphWeightsChunk(object):
    ...
    def binary(self):
        return msgpack.packb({
            "chunktype": "graph_weights", "num_vertices": self.num_vertices,
    ...
    def metadata(self, start):
        return {
            "chunktype": "graph_weights", "start": start, "length": len(self.binary)
        }
