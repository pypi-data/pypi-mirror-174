...
setuptools.setup(
    ...
    py_modules=["dragAndDrop", "alerts", "DropDown", "webWaits", "windowAndFrame", "webElement", "pollWait", "session",
                "mobAppium"],  # Name of the python package
    package_dir={'pyallied.web': 'pyallied/web', 'pyallied.mobile': 'pyallied/mobile'},
