...
class CndScaffold:
        ...
        for item in self.yaml_structure[step]:
            ...
            for value in repeat['values']:
                self._cnd_io.commit_file(
                    ...
                    self._replace_content(target, {repeat['key']: value}),
    ...
    def _push_files(self):
        return self._cnd_io.push_files(self._target['project_id'], commit_message="Pushing from CndScaffold", branch=self._target["branch"])
