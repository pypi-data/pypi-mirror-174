...
__all__ = ["CDLSHORTLINEFeature"]


class CDLSHORTLINEFeature(QuadriFeature):
  ...
  def _feature_name(self) -> str:
    return f"CDLSHORTLINE_{self.col1}_{self.col2}_{self.col3}_{self.col4}"
