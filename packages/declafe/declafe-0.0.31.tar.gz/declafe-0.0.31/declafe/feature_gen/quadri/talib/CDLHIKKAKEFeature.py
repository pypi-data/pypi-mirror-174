...
__all__ = ["CDLHIKKAKEFeature"]


class CDLHIKKAKEFeature(QuadriFeature):
  ...
  def _feature_name(self) -> str:
    return f"CDLHIKKAKE_{self.col1}_{self.col2}_{self.col3}_{self.col4}"
