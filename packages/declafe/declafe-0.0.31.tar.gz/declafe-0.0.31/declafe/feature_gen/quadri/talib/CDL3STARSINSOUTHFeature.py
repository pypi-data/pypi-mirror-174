...
__all__ = ["CDL3STARSINSOUTHFeature"]


class CDL3STARSINSOUTHFeature(QuadriFeature):
  ...
  def quadrigen(self, col1: pd.Series, col2: pd.Series, col3: pd.Series,
    ...
    return talib.CDL3STARSINSOUTH(col1, col2, col3, col4)

  def _feature_name(self) -> str:
    return f"CDL3STARSINSOUTH_{self.col1}_{self.col2}_{self.col3}_{self.col4}"
