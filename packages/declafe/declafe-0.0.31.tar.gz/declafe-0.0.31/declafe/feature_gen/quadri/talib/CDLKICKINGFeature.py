...
__all__ = ["CDLKICKINGFeature"]


class CDLKICKINGFeature(QuadriFeature):
  ...
  def _feature_name(self) -> str:
    return f"CDLKICKING_{self.col1}_{self.col2}_{self.col3}_{self.col4}"
