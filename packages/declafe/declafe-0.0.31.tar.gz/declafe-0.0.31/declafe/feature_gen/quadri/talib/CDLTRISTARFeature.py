...
__all__ = ["CDLTRISTARFeature"]


class CDLTRISTARFeature(QuadriFeature):
  ...
  def _feature_name(self) -> str:
    return f"CDLTRISTAR_{self.col1}_{self.col2}_{self.col3}_{self.col4}"
