...
__all__ = ["CDLRISEFALL3METHODSFeature"]


class CDLRISEFALL3METHODSFeature(QuadriFeature):
  ...
  def quadrigen(self, col1: pd.Series, col2: pd.Series, col3: pd.Series,
    ...
    return talib.CDLRISEFALL3METHODS(
        col1,
        col2,
        col3,
        col4,
  ...
  def _feature_name(self) -> str:
    return f"CDLRISEFALL3METHODS_{self.col1}_{self.col2}_{self.col3}_{self.col4}"
