...
__all__ = ["CDL3BLACKCROWSFeature"]


class CDL3BLACKCROWSFeature(QuadriFeature):
  ...
  def quadrigen(self, col1: pd.Series, col2: pd.Series, col3: pd.Series,
    ...
    return talib.CDL3BLACKCROWS(col1, col2, col3, col4)

  def _feature_name(self) -> str:
    return f"CDL3BLACKCROWS_{self.col1}_{self.col2}_{self.col3}_{self.col4}"
