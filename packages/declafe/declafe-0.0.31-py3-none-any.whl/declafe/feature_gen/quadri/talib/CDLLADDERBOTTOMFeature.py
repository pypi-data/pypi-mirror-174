...
__all__ = ["CDLLADDERBOTTOMFeature"]


class CDLLADDERBOTTOMFeature(QuadriFeature):
  ...
  def _feature_name(self) -> str:
    return f"CDLLADDERBOTTOM_{self.col1}_{self.col2}_{self.col3}_{self.col4}"
