...
__all__ = ["CDLTASUKIGAPFeature"]


class CDLTASUKIGAPFeature(QuadriFeature):
  ...
  def _feature_name(self) -> str:
    return f"CDLTASUKIGAP_{self.col1}_{self.col2}_{self.col3}_{self.col4}"
