...
__all__ = ["CDLHARAMICROSSFeature"]


class CDLHIGHWAVEFeature(QuadriFeature):
  ...
  def _feature_name(self) -> str:
    return f"CDLHIGHWAVE_{self.col1}_{self.col2}_{self.col3}_{self.col4}"
