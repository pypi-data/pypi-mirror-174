...
__all__ = ["CDLMATCHINGLOWFeature"]


class CDLMATCHINGLOWFeature(QuadriFeature):
  ...
  def _feature_name(self) -> str:
    return f"CDLMATCHINGLOW_{self.col1}_{self.col2}_{self.col3}_{self.col4}"
