...
__all__ = ["CDLCLOSINGMARUBOZUFeature"]


class CDLCLOSINGMARUBOZUFeature(QuadriFeature):
  ...
  def quadrigen(self, col1: pd.Series, col2: pd.Series, col3: pd.Series,
    ...
    return talib.CDLCLOSINGMARUBOZU(col1, col2, col3, col4)

  def _feature_name(self) -> str:
    return f"CDLCLOSINGMARUBOZU_{self.col1}_{self.col2}_{self.col3}_{self.col4}"
