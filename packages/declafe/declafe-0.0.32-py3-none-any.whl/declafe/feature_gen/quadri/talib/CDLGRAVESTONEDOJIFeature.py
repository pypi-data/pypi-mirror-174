...
__all__ = ["CDLGRAVESTONEDOJIFeature"]


class CDLGRAVESTONEDOJIFeature(QuadriFeature):
  ...
  def quadrigen(self, col1: pd.Series, col2: pd.Series, col3: pd.Series,
    ...
    return talib.CDLGRAVESTONEDOJI(
        col1,
        col2,
        col3,
        col4,
  ...
  def _feature_name(self) -> str:
    return f"CDLGRAVESTONEDOJI_{self.col1}_{self.col2}_{self.col3}_{self.col4}"
