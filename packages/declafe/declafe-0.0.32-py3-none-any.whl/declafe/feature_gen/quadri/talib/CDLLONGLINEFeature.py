...
__all__ = ["CDLLONGLINEFeature"]


class CDLLONGLINEFeature(QuadriFeature):
  ...
  def _feature_name(self) -> str:
    return f"CDLLONGLINE_{self.col1}_{self.col2}_{self.col3}_{self.col4}"
