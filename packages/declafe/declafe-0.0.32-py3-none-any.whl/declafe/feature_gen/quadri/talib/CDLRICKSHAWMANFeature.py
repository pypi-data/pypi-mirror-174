...
__all__ = ["CDLPIERCINGFeature"]


class CDLRICKSHAWMANFeature(QuadriFeature):
  ...
  def _feature_name(self) -> str:
    return f"CDLRICKSHAWMAN_{self.col1}_{self.col2}_{self.col3}_{self.col4}"
