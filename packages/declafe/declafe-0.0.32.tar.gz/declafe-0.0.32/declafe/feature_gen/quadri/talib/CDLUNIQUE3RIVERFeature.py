...
__all__ = ["CDLUNIQUE3RIVERFeature"]


class CDLUNIQUE3RIVERFeature(QuadriFeature):
  ...
  def _feature_name(self) -> str:
    return f"CDLUNIQUE3RIVER_{self.col1}_{self.col2}_{self.col3}_{self.col4}"
