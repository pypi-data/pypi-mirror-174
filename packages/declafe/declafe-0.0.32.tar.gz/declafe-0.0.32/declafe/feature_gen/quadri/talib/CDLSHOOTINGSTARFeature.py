...
__all__ = ["CDLSHOOTINGSTARFeature"]


class CDLSHOOTINGSTARFeature(QuadriFeature):
  ...
  def _feature_name(self) -> str:
    return f"CDLSHOOTINGSTAR_{self.col1}_{self.col2}_{self.col3}_{self.col4}"
