...
__all__ = ["CDLHOMINGPIGEONFeature"]


class CDLHOMINGPIGEONFeature(QuadriFeature):
  ...
  def _feature_name(self) -> str:
    return f"CDLHOMINGPIGEON_{self.col1}_{self.col2}_{self.col3}_{self.col4}"
