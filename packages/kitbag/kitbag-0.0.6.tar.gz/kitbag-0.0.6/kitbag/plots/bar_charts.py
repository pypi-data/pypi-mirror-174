...
import sys
from ..utils.colors import team_colors, grey, red, green, blue, yellow
#%%
...
def add_banner(fig, title, team):
    ...
    fig.text(0.67, 0.99, s=team_text, fontsize=20, fontweight="bold", va="center")
    
    # image
    logo = Image.open(str(root) + "/utils/logos/FCN Logos/FCN Logo R&Y.png")
    ax_image_home = fig.add_axes((0.85, 0.95, 0.08, 0.08))
