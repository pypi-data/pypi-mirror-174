...
def _format(response):
    if 'payment_method_id' in response and response['payment_method_id'] in card_brand_map:
        response['payment_method_id'] = str(card_brand_map[response['payment_method_id']])
