...
BioSAK get_bin_abundance -sam all_bins.sam -bin all_bins -x fa -o output.txt
...
if __name__ == "__main__":
    ...
    magabund_parser.add_argument('-sam',     required=True,                        help='input sam file')
    magabund_parser.add_argument('-mag',     required=True,                        help='MAG folder')
