...
import sys
import os
sys.path.append(os.path.abspath("/home/carlos/Documents/apps/numpy_dataframe/"))
...
#         path_rows = "/home/carlos/.tmp/rows_" + self.id + ".txt"
...
#         os.system(command)
    ...
    def get_cols(self,cols,header = True):
        ...
        path_cols = "/home/carlos/.tmp/cols_" + self.id + ".txt"
