...
class VorfinListTable(tables.Table):
    ...
    class Meta:
        ...
        fields = ["ampel", "ampel_note"]+default_cols
    ...
    def __init__(self, *args, **kwargs):
        self.base_columns['ampel'] = tables.TemplateColumn(
                        template_name = "merge/ampel_template_column.html", verbose_name="Ampel"
                    )
        self.base_columns['ampel_note'] = tables.TemplateColumn(template_name="merge/ampel_note_column.html", verbose_name="Note")
