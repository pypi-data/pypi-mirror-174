...
import re
from .models import Group, Ampel
...
class MergeSingle:
    ...
    rels = ["PersonInstitution", "PersonPlace", "PersonEvent", "PersonWork"] # Handeld seperately:, "PersonPerson"]
    
    def __init__(self, person, create=False):
        #self.group = group
        #self.members = [m.person for m in group.members.all()]
        self.meta = {"name":self.members[0].name, "first_name":self.members[0].first_name, "gender":self.group.gender}
        self.create = create
