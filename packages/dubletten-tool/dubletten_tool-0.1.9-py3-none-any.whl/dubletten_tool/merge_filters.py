...
class GenericListFilter(django_filters.FilterSet):
    ...
    def __init__(self, *args, **kwargs):
        ...
        def eliminate_unused_filters(default_filter_dict):
            ...
            enabled_filters = ["ampel"] + enabled_filters
...
class PersonListFilter(GenericListFilter):
    print("person list filter called")
    ...
    ampel = django_filters.ChoiceFilter(choices=Ampel.ampel_choices, field_name="ampel__status", label="Ampel")
    ...
    # def ampel_filter(self, queryset, value, *args, **kwargs):
    #     print("in ampel filter")
    #     print(value)
    #     print(queryset)
    #     return queryset
...
def get_list_filter_of_entity(entity):
    ...
    """
    if entity == "Person" or entity == "person":
        print("intercepted filter call")
