...
@click.option('--page', help='Current page', metavar='NUM', type=int, default=1)
@click.option('--repos-per-page', help='Repositories per page', metavar='NUM', type=int, default=20)
@click.pass_context
