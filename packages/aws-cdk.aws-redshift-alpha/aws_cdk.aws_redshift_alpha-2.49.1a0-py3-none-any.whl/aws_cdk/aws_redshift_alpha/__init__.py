...
class Cluster(
    ...
    def add_to_parameter_group(self, name: builtins.str, value: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Cluster.add_to_parameter_group)
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def _parameter_group(self, value: typing.Optional[IClusterParameterGroup]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Cluster, "_parameter_group").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class ClusterParameterGroup(
    ...
    def add_parameter(self, name: builtins.str, value: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ClusterParameterGroup.add_parameter)
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
