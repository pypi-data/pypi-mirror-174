...
setup(
    ...
    description=(
        "Type annotations for boto3.MigrationHubStrategyRecommendations 1.26.0 service generated"
        " with mypy-boto3-builder 7.11.10"
    ),
    classifiers=[
    ...
    package_data={"": ["LICENSE"], "mypy_boto3_migrationhubstrategy": ["py.typed", "*.pyi"]},
    python_requires=">=3.7",
    project_urls={
        "Documentation": (
