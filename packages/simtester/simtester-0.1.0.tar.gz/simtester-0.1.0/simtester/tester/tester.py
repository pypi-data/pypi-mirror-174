...
from simtester.config.multiwoz.mapping import *
from simtester.utils import load_yaml_configs, mp
        ...
        if isinstance(agents, str):
            if agents in tester_register_table:
                ...
                for agent in tester_register_table[agents]:
                    ...
                    agent = agent_mapping[yaml_config['model']['model_name']](config=agent)
