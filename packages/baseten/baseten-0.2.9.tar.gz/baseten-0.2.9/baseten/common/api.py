...
def deploy_development_truss(
    ...
    query_string = f'''
    mutation {{
      deploy_development_truss(name: "{model_name}",
                   s3_key: "{s3_key}",
                   config: "{config}",
                   client_version: "{client_version}",
                   is_trusted: {'true' if is_trusted else 'false'},
    ...
    '''
    resp = _post_graphql_query(api_key, query_string)
    return resp['data']['deploy_development_truss']


@with_api_key
def patch_development_truss(
    api_key,
    model_name,
    patch,
    client_version,
    ...
    query_string = f'''
    mutation {{
      patch_development_truss(name: "{model_name}",
                   client_version: "{client_version}",
                   patch: "{patch}",
) {{
        id,
    ...
    '''
    resp = _post_graphql_query(api_key, query_string)
    return resp['data']['patch_development_truss']
