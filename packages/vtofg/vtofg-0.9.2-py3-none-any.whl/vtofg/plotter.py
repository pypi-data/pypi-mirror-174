...
voltage response = 9200 N*mm/V

F = 9200*1.1/0.3 = 33733N
A = 33733*0.3/(19.7^2*pi*8300) = 0.001mm
'''
...
class Plotter(tk.Frame):
    ...
    def get_next(self):
        ...
        if len(self.waves) > 0: #prevents unnecessary calculations
            kA = 4000*np.pi*self.trans_freq_var.get()*0.0001/154000 #2kA (A = 0.0001cm, k=w/c=2*pi*f/c, f=tranducer freq, c=154000cm/s)
            ...
            for i in range(self.n_lines):
                ...
                if amps != 0:
                    sigs = sigs/amps
                sigs = sigs*kA
                sigs = np.cos(sigs) + 1j*np.sin(sigs)
