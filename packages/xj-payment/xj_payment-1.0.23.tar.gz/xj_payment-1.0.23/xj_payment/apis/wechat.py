...
# 商户证书序列号
CERT_SERIAL_NO = "4BB37FF676C847F0DFF13276DC6B8FD67B0BA9B1"

# API v3密钥， https://pay.weixin.qq.com/wiki/doc/apiv3/wechatpay/wechatpay3_2.shtml
APIV3_KEY = "105e15f0aeb885eb0707b3cc90b9f6f7"
...
class WeChatPayment(APIView):
    def pay(self):
        ...
        if code in range(200, 300):
            ...
            paysign = wxpay.sign(["wx0c2a8db23b2e7c28", timestamp, noncestr, package])
            signtype = 'RSA'
