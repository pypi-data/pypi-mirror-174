...
from xj_payment.apis import alipay, transaction_inquiry, wechat, payment
...
urlpatterns = [
    ...
    # re_path(r'^wechat_pay/?$', payment.WechatPayDAL.create_order_info),  # 微信支付接口
    ...
    re_path(r'^pay/?$', payment.Payment.pay),
