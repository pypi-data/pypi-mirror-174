"""Print an Sortmyfolder.

Usage:
    sortmyfolder [--location=LOCATION]
...
def main():
    ...
    given_argument = args['--location']     
    print('its given as :', given_argument)
    print('the type is ', type(given_argument))
    WhereToSortFiles().location_of_folder_creation(given_argument)

# def main():
#     args = docopt.docopt(__doc__)
#     given_argument = args['--location']
#     print('Emmanuel it works here: Argument is : ---> ', given_argument)
