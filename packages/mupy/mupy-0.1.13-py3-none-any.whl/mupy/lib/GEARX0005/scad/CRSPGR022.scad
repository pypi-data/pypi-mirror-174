...
//spur_gear(modul=2, tooth_number=30, width=5, bore=4, pressure_angle=20, helix_angle=20, optimized=true);
...
//bevel_gear(modul=3, tooth_number=16,  partial_cone_angle=45, tooth_width=9, bore=6, pressure_angle=20, helix_angle=0);
...
module CRSPGR022_R(modul, length, height, width, pressure_angle=20, helix_angle=0)
{
    rack(modul, length, height, width, pressure_angle, helix_angle);
}

module CRSPGR022_BG(modul, tooth_number, partial_cone_angle, tooth_width, bore, pressure_angle=20, helix_angle=0)
{
    bevel_gear(modul, tooth_number,  partial_cone_angle, tooth_width, bore, pressure_angle, helix_angle);
}

CRSPGR022_BG(modul=3, tooth_number=16,  partial_cone_angle=45, tooth_width=9, bore=6, pressure_angle=20, helix_angle=0);