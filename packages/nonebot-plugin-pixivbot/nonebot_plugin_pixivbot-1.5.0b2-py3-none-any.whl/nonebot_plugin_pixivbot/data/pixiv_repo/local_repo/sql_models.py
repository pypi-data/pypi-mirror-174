...
class IllustSetCacheIllust:
    ...
    cache_id: int = Column(Integer, ForeignKey("illust_set_cache.id"), primary_key=True, nullable=False)
    illust_id: int = Column(Integer, primary_key=True, nullable=False)
...
class UserSetCacheUser:
    ...
    cache_id: int = Column(Integer, ForeignKey("user_set_cache.id"), primary_key=True, nullable=False)
    user_id: int = Column(Integer, primary_key=True, nullable=False)
