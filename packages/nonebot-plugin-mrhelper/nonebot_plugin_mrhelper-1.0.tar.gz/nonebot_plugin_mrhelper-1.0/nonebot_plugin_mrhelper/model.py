...
class Config(BaseModel, extra=Extra.ignore):
    ...
    mrhelper_db: Optional[str] = os.path.split(os.path.realpath(__file__))[0] + "/mrhelper.db"
    mrhelper_admin: Optional[int]
    mrhelper_embyurl: Optional[str] = None
    mrhelper_embyapikey: Optional[str] = None
    mrhelper_enable_registeremby: Optional[bool] = False
    mrhelper_enable_pushnotify: Optional[bool] = True
