...
def lois_ds_report(data, target_variable:str, report_complexity="simple"):
    ...
    print(Panel(" ", title="Exploratory Data Anlysis" ,subtitle="EDA| Complexity is simple| Suitable for data scientis",
                    title_align="center", subtitle_align="center", highlight=True) )
    ...
    ####################################################################################################################
    #TODO find a way to interprate and summary the result
