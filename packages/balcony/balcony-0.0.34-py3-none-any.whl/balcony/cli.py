...
def _complete_operation_type(ctx: typer.Context):
    ...
    print(f"{operation_types_and_names=}")
...
def aa():
    ...
    a = _complete_operation_type(None, None)
    print(a)
...
def aws_main_command(
        ...
        operation: Optional[OperationType] = typer.Argument(None, show_default=False,case_sensitive=False ,expose_value=False, show_choices=False,help='Select a specific operation type.', autocompletion=_complete_operation_type),
