...
def aws_main_command(
        ...
        operation: Optional[OperationType] = typer.Argument(None, show_default=False,case_sensitive=False , show_choices=False,help='Select a specific operation type.', autocompletion=_complete_operation_type),
