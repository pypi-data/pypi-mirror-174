...
parser.add_argument('-v', '--version', version=version, help="显示版本")
parser.add_argument('-u', '--url', type=str, help='swagger api地址（必填)', required=True)
parser.add_argument('-U', '--username', default=None, type=str, help='swagger用户名')
parser.add_argument('-P', '--password', default=None, type=str, help='swagger密码')
