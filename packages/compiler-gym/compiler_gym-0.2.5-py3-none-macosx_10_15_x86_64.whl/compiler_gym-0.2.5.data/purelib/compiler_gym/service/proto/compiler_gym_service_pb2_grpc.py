...
class CompilerGymServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendSessionParameter = channel.unary_unary(
                '/compiler_gym.CompilerGymService/SendSessionParameter',
                request_serializer=compiler__gym_dot_service_dot_proto_dot_compiler__gym__service__pb2.SendSessionParameterRequest.SerializeToString,
                response_deserializer=compiler__gym_dot_service_dot_proto_dot_compiler__gym__service__pb2.SendSessionParameterReply.FromString,
                )
...
class CompilerGymServiceServicer(object):
    ...
    def SendSessionParameter(self, request, context):
...
def add_CompilerGymServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SendSessionParameter': grpc.unary_unary_rpc_method_handler(
                    servicer.SendSessionParameter,
                    request_deserializer=compiler__gym_dot_service_dot_proto_dot_compiler__gym__service__pb2.SendSessionParameterRequest.FromString,
                    response_serializer=compiler__gym_dot_service_dot_proto_dot_compiler__gym__service__pb2.SendSessionParameterReply.SerializeToString,
            ),
    }
...
class CompilerGymService(object):
    ...
    @staticmethod
    def SendSessionParameter(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/compiler_gym.CompilerGymService/SendSessionParameter',
            compiler__gym_dot_service_dot_proto_dot_compiler__gym__service__pb2.SendSessionParameterRequest.SerializeToString,
            compiler__gym_dot_service_dot_proto_dot_compiler__gym__service__pb2.SendSessionParameterReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
