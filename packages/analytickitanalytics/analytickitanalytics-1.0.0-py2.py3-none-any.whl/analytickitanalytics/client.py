...
from analytickitanalytics.consumer import Consumer
from analytickitanalytics.feature_flags import InconclusiveMatchError, match_feature_flag_properties
from analytickitanalytics.poller import Poller
from analytickitanalytics.request import APIError, batch_post, decide, get
from analytickitanalytics.utils import SizeLimitedDict, clean, guess_timezone
...
class Client(object):
    """Create a new AnalyticKit client."""
    ...
    def _enqueue(self, msg):
        ...
        if not msg.get("properties"):
            msg["properties"] = {}
        msg["properties"]["$lib"] = "analytickit-python"
        ...
        try:
            ...
            if e.status == 401:
                raise APIError(
                    ...
                    "More information: https://analytickit.com/docs/api/overview",
                )
            else:
