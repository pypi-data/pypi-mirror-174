...
class HTTPStatus(Enum):
    ...
    PORN_FLOAT_TYPE_ERR = (400008, "请求体的参数字段类型错误", "PornThresh 字段应该是 float 类型")  # 内容审核色情
    TERROR_FLOAT_TYPE_ERR = (400008, "请求体的参数字段类型错误", "TerrorThresh 字段应该是 float 类型")  # 内容审核暴恐
    POLITIC_FLOAT_TYPE_ERR = (400008, "请求体的参数字段类型错误", "PoliticThresh 字段应该是 float 类型")  # 内容审核政治
    ...
    VIDEO_TYPE_DOC_ERR = (400012, "文件格式不合法", "支持的音频格式请参考接口文档说明")
