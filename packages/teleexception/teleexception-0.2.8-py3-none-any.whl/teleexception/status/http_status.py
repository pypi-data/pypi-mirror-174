...
class HTTPStatus(Enum):
    ...
    PUBLIC_THRESH_VALUE_ERR = (400008, "请求体的参数字段类型错误", "PublicThresh 字段不符合规范，请参考接口文档说明")  # 内容审核公众人物
    OCR_THRESH_VALUE_ERR = (400008, "请求体的参数字段类型错误", "OCRThresh 字段不符合规范，请参考接口文档说明")  # 内容审核OCR
