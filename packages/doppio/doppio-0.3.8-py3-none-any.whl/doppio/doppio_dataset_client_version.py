    ...
    def __init__(self, dataset=None, split_dir=None, task_info=None, augmentation=None, valid_classes=None):
       ...
       # print(url_files)
        ...
        if "segmentation_mask" in self.task:
            ...
            print("self.classes_total", self.classes_total)
...
def doppio(dataset=None, split_dir=None, task_info=None, augmentation = None):

    if augmentation == None:
        augmentation =  [A.Resize(width=1000, height=1000), ToTensorV2(transpose_mask=True)]


    custom_dataset = DoppioDataset(dataset=dataset, split_dir=split_dir, task_info=task_info, augmentation=augmentation)# [A.Resize(width=512, height=512),ToTensorV2(transpose_mask=True)])
