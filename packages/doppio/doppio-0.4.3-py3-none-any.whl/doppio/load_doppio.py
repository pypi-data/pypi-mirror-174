...
def doppio(dataset, split_dir, task_info):


    resource_package = pkg_resources.get_distribution('package_name').location
    config_path = os.path.join(resource_package,'doppio/doppio_client_t.txt')
    ...
    dataloader = module.doppio(dataset=dataset, split_dir=split_dir, task_info=task_info)    # hello 모듈의 printHello() 함수 호출
