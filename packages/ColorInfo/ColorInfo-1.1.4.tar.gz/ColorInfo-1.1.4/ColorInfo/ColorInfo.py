...
class ColorLogger:
	...
	def set_format(self, date_on=True, time_on=True, filename_on=True, class_on=True, fun_on=True, line_on=True, level_on=True):
		"""
		设置格式开关,默认全开
		:param level_on: 是否显示等级(默认: True)-DEBUG
		...
		self.format_line = line_on
		self.format_level = level_on
