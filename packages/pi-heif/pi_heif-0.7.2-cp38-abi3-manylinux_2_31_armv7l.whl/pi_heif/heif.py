...
class HeifFile:
    ...
    * :py:func:`~pi_heif.from_bytes`
    ...
    def scale(self, width: int, height: int) -> None:
        """Scale primary image in the container. See :py:meth:`~pi_heif.HeifImage.scale`"""
    ...
    def save(self, fp, **kwargs) -> None:
        ...
        Supported options:
            ...
            ``quality`` - see :py:attr:`~pi_heif._options.PyLibHeifOptions.quality`
...
def check_heif(fp):
    ...
    :returns: Value from :py:class:`~pi_heif.HeifFiletype` enumeration."""
