...
class PyLibHeifOptions:
    ...
    def strict(self) -> bool:
        ...
        Affects on return result of :py:func:`~pi_heif.is_supported` function
    ...
    def quality(self) -> Union[int, None]:
        ...
        .. note:: Quality specified during :py:meth:`~pi_heif.HeifFile.save`
...
def options() -> PyLibHeifOptions:
    ...
    :returns: A :py:class:`~pi_heif._options.PyLibHeifOptions` class."""
