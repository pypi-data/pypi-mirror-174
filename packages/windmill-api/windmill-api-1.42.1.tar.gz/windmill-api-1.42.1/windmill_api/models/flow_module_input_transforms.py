    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for prop_name, prop_dict in d.items():
            ...
            def _parse_additional_property(
                ...
                try:
                    additional_property_type_0: FlowModuleInputTransformsAdditionalPropertyType0
                ...
                if not isinstance(data, dict):
                    raise TypeError()
                additional_property_type_1: FlowModuleInputTransformsAdditionalPropertyType1
