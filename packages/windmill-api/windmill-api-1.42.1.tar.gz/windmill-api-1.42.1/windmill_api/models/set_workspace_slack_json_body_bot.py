...
T = TypeVar("T", bound="SetWorkspaceSlackJsonBodyBot")


@attr.s(auto_attribs=True)
class SetWorkspaceSlackJsonBodyBot:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        set_workspace_slack_json_body_bot = cls(
            bot_access_token=bot_access_token,
        )

        set_workspace_slack_json_body_bot.additional_properties = d
