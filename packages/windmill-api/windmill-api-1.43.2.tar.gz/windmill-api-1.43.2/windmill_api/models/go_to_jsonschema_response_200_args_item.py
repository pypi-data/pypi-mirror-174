...
class GoToJsonschemaResponse200ArgsItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_typ(
            ...
            try:
                typ_type_0: GoToJsonschemaResponse200ArgsItemTypType0
                ...
                pass
            try:
                typ_type_1: GoToJsonschemaResponse200ArgsItemTypType1
                ...
                pass
            try:
                typ_type_2: GoToJsonschemaResponse200ArgsItemTypType2
                if not isinstance(data, dict):
                    raise TypeError()
                ...
                pass
            try:
                typ_type_3: GoToJsonschemaResponse200ArgsItemTypType3
                if not isinstance(data, dict):
                    raise TypeError()
            ...
            if not isinstance(data, dict):
                raise TypeError()
            typ_type_4: GoToJsonschemaResponse200ArgsItemTypType4
