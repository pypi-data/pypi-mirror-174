...
import asyncio
from typing import Dict, List, Callable, Iterable, Union, AsyncIterator
...
class Context(BasicContext):
    ...
    @asynccontextmanager
    async def cd(self, cwd: str) -> AsyncIterator:
    ...
    async def shell(self, cmd: str,
        ...
        watcher_objs = [Watcher(pattern=p, response=r) for p, r in watchers.items()]
