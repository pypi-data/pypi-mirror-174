...
USA_PALETTES = dict(
	...
	Arizona = dict(colors = ('#e39a27', '#f2d6a2', '#d17d5e', '#603d42', '#aa5a40', '#3c3963'), order = (2, 1, 3, 5, 4, 6), colorblind = True))

COLORBLIND_PALETTE_NAMES = ('Alaska', 'Arizona')
print(COLORBLIND_PALETTE_NAMES)
COLORBLIND_PALETTES = {name: USA_PALETTES[name] for name in COLORBLIND_PALETTE_NAMES}
print(COLORBLIND_PALETTES)
