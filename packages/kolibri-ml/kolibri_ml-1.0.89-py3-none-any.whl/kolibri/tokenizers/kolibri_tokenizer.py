...
class KolibriTokenizer(Tokenizer):
    ...
    def __init__(self, configs=None):
        ...
        patterns =[self.EXCEPTIONS, common_regs.URL, common_regs.MONEY]
        ...
        patterns.append(common_regs.DURATION)

        for phone in list(common_regs.PHONE_NUMBER.values()):
            patterns.append(phone)

        patterns.extend([self.OPENPARENTHESIS, self.CLOSEPARENTHESIS, self.IBAN,  self.WS,self.URL, self.ENERGY_INDEX, self.EMAIL, self.MULTIPLEWORD,  self.ACORNYM,self.NUM, self.PLUS, self.MINUS, self.ELLIPSIS, self.DOT, self.TIMES, self.EQ,
        ...
        patterns.extend([self.CANDIDATE,  self.WORD, self.OTHER])
