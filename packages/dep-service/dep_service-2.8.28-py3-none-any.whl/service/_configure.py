...
maintain_router = types.Router(prefix='/service', tags=['service'])


@maintain_router.get('/health')
...
def prepare_routers(
    ...
    if maintain:
        app.router.include_router(maintain_router)
...
def create(
    ...
    prepare_routers(app=app, routers=routers, maintain=maintain)
