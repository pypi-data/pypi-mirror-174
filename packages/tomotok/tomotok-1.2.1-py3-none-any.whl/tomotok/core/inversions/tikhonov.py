...
class Tikhonov(object):
    r"""
    Templeta class that implements Phillips-Tikhonov regularisation scheme.
    
    Does not implement any method for obtainign regularisation matrix nor inversion run
