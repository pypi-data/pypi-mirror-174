...
def getting_started():
    ...
    with col:
        ...
        st.markdown(
            """
    ### Our [Documentation](https://encord-active-docs.web.app/) contains eveything there is to know about Encord Active
    """
        )
...
Some indexes only give information about the data without not meaning any quality (level of contrast, red density etc.),
 meanwhile, some indexes define the quality (Annotation quality etc.).
"""
    )
