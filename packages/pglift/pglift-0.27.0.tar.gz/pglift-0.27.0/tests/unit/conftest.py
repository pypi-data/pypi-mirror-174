...
from pglift.pgbackrest import impl as pgbackrest_mod
...
def _instance(
    ...
    pgbackrest = pgbackrest_models.Service(stanza="mystanza")
    ...
    stanza_config = pgbackrest_mod.stanza_config("mystanza", settings.pgbackrest)
