...
def test_apply(
    ...
    with postgresql.running(ctx, i):
        ...
        assert db2.extensions == [interface.Extension.unaccent]
    ...
    if surole.password:
        ...
        def get_stdby() -> Optional[Standby]:
            ...
            with patch.dict(
                ...
                return instances._get(ctx, standby_instance)._standby()
...
def test_extensions(
    ...
    assert postgresql.status(ctx, instance) == Status.not_running
