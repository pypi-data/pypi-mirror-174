...
class Uploader(zip_install.RequireFile):
    ...
    def upload(self, install_data, remote_data, requires_data: dict, deploy: bool):
        """
    ...
    def gen(self, install_data, remote_data, requires_data: dict, deploy: bool):
        """
        ...
        for root, shasum in requires_data.items():
            ...
            if uploaders.api_check_is_uploaded(root, shasum, tag, remote_data):
                yield f"{root} already uploaded"
            else:
