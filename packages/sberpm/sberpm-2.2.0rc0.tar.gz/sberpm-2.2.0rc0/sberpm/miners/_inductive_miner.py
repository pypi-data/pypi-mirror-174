...
from sberpm.miners import _inductive_utils as utils
...
class ProcessTreeNode:
    ...
    def __init__(self, parallel_activity, graph=None, start_nodes=None, end_nodes=None, type_=None, label=None):
